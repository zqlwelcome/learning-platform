...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 Meta与Anthropic洽谈百亿美元算力合作 催生AI基础设施变现新…，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
            ...
            {
                "label": "商品",
                "value": "Meta与Anthropic洽谈百亿美元算力合作 催生AI基础设施变现新模式 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "领益智造：港股破发、收入增长“刹车”，豪掷40亿跨界光纤求突围 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "韩国公布放宽外国投资者交易韩元的详细计划 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。Meta与Anthropic洽谈百亿美元算力合作 催生AI基础设施变现新模式 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 估值超百亿，一目科技完成超10亿元新融资，多家一线基金参… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。中泰证券：从算力通胀到股权财政 下半年资产主线如何演绎？ 可以看，但不能替代财报、负债和自由现金流。",
