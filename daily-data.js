...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 德意志银行：如果美联储加息，黄金价格可能会跌至3800美元/盎司，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 芯片股创新高！存储爆发美光涨近7%，SpaceX、谷歌重挫市值蒸发超…；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "德意志银行：如果美联储加息，黄金价格可能会跌至3800美元/盎司 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "德意志银行：如果美联储加息，黄金价格可能会跌至3800美元/盎司 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "德意志银行：如果美联储加息，黄金价格可能会跌至3800美元/盎司 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "交易押注澳联储加息周期或终结，澳元跌势将延续 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。德意志银行：如果美联储加息，黄金价格可能会跌至3800美元/盎司 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 德意志银行：如果美联储加息，黄金价格可能会跌至3800美… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。交易押注澳联储加息周期或终结，澳元跌势将延续 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：德意志银行：预计第三季度黄金价格将达到4300美元/盎司，第四季度将达4800美元/盎司 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。芯片股创新高！存储爆发美光涨近7%，SpaceX、谷歌重挫市值蒸发超5000亿美元 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
    ...
    return [
        {
            date: '2026-06-17',
            label: '06/17 结果',
            event: '美联储FOMC：维持利率但转向“防通胀”',
            region: '全球利率',
            impact: 'high',
            summary: '结果+市场解读：FOMC维持 3.50%-3.75% 不变，但会后叙事从“等降息”转向“先确认通胀能回2%”。市场不再只看这次没加息，而是重新给能源通胀、数据依赖和更少前瞻指引定价。',
            thesis: '先改利率预期和流动性，再压风险偏好。核心不是利率没动，而是降息门槛抬高，长久期资产要重新消化高利率更久。',
            assets: '2年和10年美债、美元、黄金、原油、纳指、A股和港股科技、REITs、高股息。',
            flow: '热钱会先守美元、短债、金融和能源，少追高估值成长与新兴市场弹性。若2年美债收益率、美元同步上行，黄金和港股科技转弱，说明资金正在交易“钱更贵、波动更贵”。',
            plan: '如果本周PCE继续偏热且美债收益率上行，倾向降低长久期成长和港股高弹性仓位；如果PCE降温并带动收益率回落，再观察黄金、纳指和港股科技能否放量修复。',
            plain: '美联储没踩刹车，但也没准备马上给市场放水。'
        },
        {
            date: '2026-06-22',
            label: '06/22 结果',
            ...
            region: '中国政策',
            impact: 'medium',
            summary: '结果+市场解读：1年期LPR维持 3.00%，5年期以上LPR维持 3.50%。这说明货币端继续稳信用，但没有用降贷款基准利率去强刺激地产和居民加杠杆。',
            thesis: '改的是政策预期和信用预期。1年期影响企业融资，5年期影响按揭和地产信心；两端都不动，市场会把政策理解成托底而非总攻。',
            assets: 'A股银行、地产链、建材、家电、券商、国债、人民币、港股内房和本地金融、高股息央国企。',
            flow: '热钱更可能继续留在红利、高股息、出口制造、AI硬件和债券，少做地产链与纯内需β。如果地产股不跟、银行红利稳，说明资金接受“弱刺激、弱修复”。',
            plan: '如果后续地产成交和社融没有改善，倾向把内需反弹当交易而不是反转；如果财政加码、人民币走稳和地产成交同步修复，再提高消费、券商和地产链观察权重。',
            plain: '贷款利率没降，意思是政策还在托底，但还没给楼市猛踩油门。'
        },
        {
            date: '2026-06-23',
            label: '06/23',
            event: '美国6月S&P Global PMI初值',
            region: '美国增长',
            impact: 'medium',
            summary: '预期窗口：本周二公布制造业和服务业PMI初值。市场会用它判断美国经济是“高通胀但还能扩张”，还是开始出现需求降温。它是6月PCE和7月非农前的第一道风险偏好检查。',
            thesis: '先改盈利预期和风险偏好，再通过价格分项影响利率预期。PMI强但价格也强，会变成“增长好、降息更远”。',
            assets: '纳指、标普周期股、罗素2000、美元、2年美债、黄金、铜、原油、港股科技。',
            flow: '如果PMI和价格分项一起走强，资金可能买周期和美元、压黄金和长久期成长；如果订单走弱但价格仍高，市场会交易滞胀，热钱更偏现金、黄金和防御股。',
            plan: '如果PMI强于预期且收益率上行，倾向少追高估值科技；如果PMI走弱但收益率回落，可观察黄金和科技反弹，但要防止“增长坏消息”压制股票β。',
            plain: '这份数据看美国企业还忙不忙，也看物价压力有没有继续烫。'
        },
        {
            date: '2026-06-25',
            label: '06/25',
            event: '美国Q1终值GDP + 5月PCE',
            region: '美国通胀',
            impact: 'high',
            summary: '预期窗口：BEA 6月25日同时公布Q1 GDP三次估计和5月个人收入支出，PCE通胀是主菜。美联储刚把焦点放回物价，这份数据会决定“年内加息风险”还是“降息交易回补”占上风。',
            thesis: '先改利率预期和流动性，再改科技股、黄金、美元和人民币定价。GDP终值验证增长韧性，PCE决定政策定价。',
            assets: '2年美债、美元、黄金、纳指、比特币、港股科技、人民币汇率、原油。',
            flow: '如果核心PCE高于预期，资金会继续留在美元、短债、金融和能源；如果核心PCE回落，热钱更可能从现金和防御回流科技、黄金和港股弹性。先盯2年美债、美元和黄金。',
            plan: '如果核心PCE偏强，倾向减轻高估值成长追涨；如果核心PCE偏弱且收益率回落，可关注黄金、纳指和港股科技的修复，但要等价格确认而不是抢跑。',
        ...
        },
        {
            ...
            region: '中国盈利',
            impact: 'medium',
            summary: '预期窗口：中国工业利润会检验“制造强、内需弱”能不能继续撑A股盈利。前期利润改善更多来自AI相关需求、能源价格和上游行业，市场会看中下游利润有没有扩散。',
            thesis: '改的是盈利预期和风格预期。利润只集中在上游和少数制造，指数就难全面扩散；利润扩到中游和消费，A股风险偏好才更稳。',
        ...
        },
        {
            ...
            region: '欧洲利率',
            impact: 'medium',
            summary: '预期窗口：ECB年度央行论坛在6月29日至7月1日举行，7月1日还有欧元区6月通胀初值。欧洲5月通胀已回到3%以上，市场会听欧洲央行是否继续压制降息预期。',
            thesis: '改的是欧洲利率预期和美元指数结构，再间接影响黄金、人民币和全球成长股估值。',
            assets: '欧元、德债、美元指数、黄金、欧洲银行、奢侈品、A股和港股外资风险偏好。',
            flow: '如果欧洲通胀和央行讲话偏鹰，资金会买欧元和欧洲银行，同时压制黄金和高估值成长；如果通胀降温、欧洲央行口径缓和，热钱可能回补黄金、科技和新兴市场。',
            plan: '如果欧元和德债收益率同步走强，倾向把全球高利率交易延长；如果欧洲通胀低于预期且美元走弱，可关注黄金、港股科技和人民币资产的修复窗口。',
            plain: '欧洲如果也不急着降息，全球市场就更难等到一轮大放水。'
        },
        {
            date: '2026-06-30',
            label: '06/30',
            ...
            region: '中国景气',
            impact: 'high',
            summary: '预期窗口：5月官方制造业PMI为50.0，新订单低于荣枯线，非制造业靠服务业勉强修复。6月PMI会告诉市场，“生产撑住、需求偏弱”的组合是在改善还是继续拖累内需资产。',
            thesis: '先改盈利预期和政策预期，再改A股和港股的风格切换。',
            assets: 'A股制造业链、资源周期、工程机械、消费、国债、人民币、港股工业和互联网。',
            flow: '如果制造业PMI回升而价格分项不再恶化，资金会继续留在制造和顺周期，不急着去地产链；如果PMI再走弱，热钱会回高股息、债券和出口龙头，回避内需总攻叙事。',
            plan: '如果PMI改善但地产和消费指标仍弱，倾向继续做“制造强、内需弱”的结构；如果PMI和人民币同步回稳，再提高对A股顺周期和港股β的观察权重。',
            plain: '这一天看的是工厂老板有没有比上个月更敢接单、更敢补库存。'
        },
        {
            date: '2026-07-01',
            label: '07/01',
            event: '中国RatingDog PMI + 美国ISM制造业',
            region: '全球制造',
            impact: 'high',
            summary: '预期窗口：中国私营制造业PMI和美国ISM制造业同日接力。前者看外需订单和中小企业景气，后者看美国制造、价格分项和库存周期，合起来决定全球制造链风险偏好。',
            thesis: '同时改盈利预期、利率预期和商品需求预期。中国PMI强说明出口链还稳，美国ISM强但价格也强则会推高“增长好、降息远”的定价。',
            assets: 'A股出口链、港股工业、铜、原油、美元、美债、纳指、半导体、机械、电力设备。',
            flow: '如果中美PMI都强，资金会偏制造、周期和AI硬件；如果美国价格分项强而中国订单弱，热钱会买美元和短债，撤出新兴市场高β。若两边同时走弱，资金会回债券、黄金和防御。',
            plan: '如果中国PMI改善且人民币走稳，可提高出口制造和港股β观察权重；如果美国ISM强到推升收益率，倾向控制高估值科技追涨。',
            plain: '这一天看全球工厂链：订单有没有、成本烫不烫、资金敢不敢买风险。'
        },
        {
            date: '2026-07-02',
            label: '07/02',
            ...
            region: '美国就业',
            impact: 'high',
            summary: '预期窗口：美国劳工统计局日程已把6月非农定在7月2日公布。FOMC已经偏鹰，这份就业数据会决定市场是否继续相信“经济还扛得住高利率”。',
        ...
        },
        {
            date: '2026-07-03',
            label: '07/03',
            event: '美国独立日假期前后流动性窗口',
            region: '市场流动性',
            impact: 'medium',
            summary: '预期窗口：美国7月3日因独立日休市，7月2日非农之后会进入假期低流动性。数据若超预期，薄交易容易放大美元、美债、黄金和股指期货波动。',
            thesis: '改的是流动性和风险偏好。不是宏观新数据本身，而是“重磅数据+假期薄盘”会让同样的消息打出更大的价格波动。',
            assets: '美元指数、美债期货、黄金、原油、纳指期货、港股科技、A股高β题材。',
            flow: '如果非农后美元和美债收益率单边走强，假期前资金可能继续降风险；如果收益率回落但股指不跟涨，说明资金更担心增长而不是宽松。',
            plan: '如果非农后出现薄盘急涨急跌，倾向等7月6日美国服务业数据和成交量恢复后再确认方向；如果价格和成交同时确认，再考虑跟随主线。',
            plain: '假期前市场人少，消息容易被价格放大，不适合只看一根K线下结论。'
        },
        {
            date: '2026-07-06',
            label: '07/06',
            ...
            region: '美国服务通胀',
            impact: 'high',
            summary: '预期窗口：7月6日是未来两周最后一个关键美国数据。服务业比制造业更贴近工资、租金和核心通胀，所以它会影响市场对7月美联储会议前的最终利率定价。',
            thesis: '先改服务通胀和利率预期，再改风险偏好。服务业太强会让“通胀粘性”重新压住降息交易。',
            assets: '2年美债、美元、纳指、消费股、金融、黄金、原油、港股科技、人民币。',
            flow: '如果服务业PMI和价格分项偏强，热钱会继续偏美元、金融和短债，减少黄金和成长股追价；如果服务业降温且就业分项走弱，资金可能回流债券、黄金和科技反弹。',
            plan: '如果服务业强于预期，倾向继续控制成长股和新兴市场高β仓位；如果服务业明显降温且收益率下行，可关注黄金和科技，但要把仓位建立在价格确认上。',
            plain: '美国服务业如果还很热，美联储就更难放心降温。'
        }
    ];
}
