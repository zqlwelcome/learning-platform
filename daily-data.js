...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "宏观",
                "value": "指剔除能源的通胀“也过热” 堪萨斯城联储行长支持加息 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
            ...
            {
                "label": "中国资产",
                "value": "管涛：统筹推进人民币国际化与资本项目开放 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 指剔除能源的通胀“也过热” 堪萨斯城联储行长支持加息 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
