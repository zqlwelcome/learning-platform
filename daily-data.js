...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 央行：初步统计，2026年7月末社会融资规模存量为463.27万亿元，同…，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 标普迎里程碑！存储芯片爆发，闪迪飙涨超13%，金银原油齐下挫；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "央行：7月份同业拆借加权平均利率为1.4%，比上月低0.01个百分点 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "标普迎里程碑！存储芯片爆发，闪迪飙涨超13%，金银原油齐下挫 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "花旗资深投行家将跳槽高盛，港股IPO升温，香港投行核心人员流转加剧 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "央行：初步统计，2026年7月末社会融资规模存量为463.27万亿元，同比增… 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。央行：初步统计，2026年7月末社会融资规模存量为463.27万亿元，同比增长7.4% 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 央行：7月份同业拆借加权平均利率为1.4%，比上月低0.… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。央行：7月份同业拆借加权平均利率为1.4%，比上月低0.01个百分点 可以看，但不能替代财报、负债和自由现金流。",
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。标普迎里程碑！存储芯片爆发，闪迪飙涨超13%，金银原油齐下挫 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
