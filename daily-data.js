...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 日本央行七月会议意见摘要：一名成员表示，随着油价上涨传导至消费者通胀，全…，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 日本央行七月会议意见摘要：一名成员表示，随着油价上涨传导至消费者通胀…；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "1. 中新经纬从银行、房产中介等多方了解到，低于3%的房贷利率只是少数外资银… 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "日本央行七月会议意见摘要：一名成员表示，随着油价上涨传导至消费者通胀，全球人… 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "1. 中新经纬从银行、房产中介等多方了解到，低于3%的房贷利率只是少数外资银… 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "日本央行将于十分钟后公布7月货币政策会议审议委员意见摘要 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。日本央行七月会议意见摘要：一名成员表示，随着油价上涨传导至消费者通胀，全球人工智能需求以及日 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 1. 中新经纬从银行、房产中介等多方了解到，低于3%的房… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。1. 中新经纬从银行、房产中介等多方了解到，低于3%的房贷利率只是少数外资银行在部分地区推出 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：日本央行七月会议意见摘要：一名成员表示，考虑到因日元疲软和强劲的人工智能相关需求带来的通胀上 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。日本央行七月会议意见摘要：一名成员表示，随着油价上涨传导至消费者通胀，全球人工智能需求以及日 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
