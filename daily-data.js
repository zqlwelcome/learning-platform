...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 国际现货黄金现价近端少量增持，但更上方41XX减持超百手，可能限制上行幅…，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 7月10日隔夜要闻：美股收高 芯片股普涨 美官员称美伊相关技术谈判仍…；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "美联储主席沃什敲定央行改革顾问团队人选 前英国央行行长等知名人士在列 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "国际现货黄金现价近端少量增持，但更上方41XX减持超百手，可能限制上行幅度 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "净流入超120亿元！芯片股“吸金” 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "大华继显：友邦保险目标价降至100港元 重申“买入”评级 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。国际现货黄金现价近端少量增持，但更上方41XX减持超百手，可能限制上行幅度 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 美联储主席沃什敲定央行改革顾问团队人选 前英国央行行长等… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。四三九九、贪玩、巨人三家游戏厂商同时下场 VAST超10亿A3轮融资背后的“3D生产力”逻辑 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：SK海力士美股IPO定价149美元，融资规模将达265亿美元 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。7月10日隔夜要闻：美股收高 芯片股普涨 美官员称美伊相关技术谈判仍在继续 SK海力士ADS定价每份14… 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
    ...
    return [
        {
            ...
            region: '美元利率',
            impact: 'high',
            summary: '结果+市场解读：美联储6月会议维持联邦基金目标区间在3.50%-3.75%，纪要显示官员对通胀路径分歧加大，部分人担心能源、关税和AI资本开支推高价格粘性。10年期美债续发收益率在4.58%附近，需求没有失控，但收益率中枢仍高。市场更像在交易“降息更远、长端供给仍要给溢价”。',
            thesis: '改的是利率预期、期限溢价和全球风险偏好。纪要偏鹰会抬高实际利率，拍卖能接住说明不是流动性危机，但高收益率仍压估值。',
            assets: '10年美债、2年美债、美元、黄金、纳指、半导体、比特币、港股科技、人民币、A股成长。',
            flow: '如果2年和10年收益率同步上行、美元走强，说明热钱回到美元现金和短债；如果收益率高位回落、黄金和科技同步走强，说明市场把高利率当成尾声而不是新一轮收紧。',
            plan: '如果10年收益率继续上破并带动美元走强，倾向降低高估值成长和港股高β；如果收益率回落且美元转弱，可关注黄金、长债和科技修复，但不追单日急拉。',
            plain: '美联储还没准备松口，债市也在要求更高回报，成长股要先看利率脸色。'
        },
        {
            date: '2026-07-09',
            label: '07/09 结果+今晚',
            ...
            region: '中美价格',
            impact: 'high',
            summary: '结果+市场解读：中国6月CPI同比上涨1.0%、环比下降0.3%，核心CPI同比上涨1.0%；PPI同比上涨4.1%、环比下降0.3%。这说明消费端仍温和，上游价格有同比支撑但环比不再加速。今晚美国30年期国债拍卖继续检验长钱久期需求，若接盘弱，会把全球贴现率压力重新传到成长股。',
            thesis: '改的是中国盈利预期、政策预期和全球期限溢价。CPI不热，政策仍有空间；PPI同比高但环比降，说明资源利润有支撑，但不能直接推成全面通胀行情。',
            assets: 'A股消费、资源周期、化工、有色、港股消费、人民币、30年美债、黄金、全球成长股。',
            flow: '若人民币稳定、消费板块放量，说明资金把低CPI理解为政策空间；若只涨有色、化工和煤油，说明市场只交易上游价格。若30年美债收益率跳升，热钱会先撤高估值成长，回美元和短债。',
            plan: '如果人民币走稳且消费数据后续改善，可关注消费和顺周期扩散；如果PPI强、CPI弱，倾向只做上游结构；如果美国长端收益率上冲，先控制科技成长追涨。',
            plain: '中国不是全面涨价，而是上游比下游更硬；今晚还要看美国长债会不会压全球估值。'
        },
        {
            date: '2026-07-10',
            label: '07/10-07/13',
            ...
            region: '中国外需/流动性',
            impact: 'high',
            summary: '预期窗口：海关6月进出口看外需订单，央行月中信贷社融看国内信用是否接力。市场不会只看出口增速或社融总量，要同时看出口量价、进口需求、企业中长期贷款、居民贷款和政府债融资。外需强但内需弱，是出口链结构行情；外需稳、信用也修复，才更像风险偏好扩散。',
        ...
        },
        {
            ...
            region: '中美需求',
            impact: 'high',
            summary: '预期窗口：国家统计局日程显示7月16日有季度主要行业增加值初步核算报告，市场会同步盯中国二季度GDP、工业、消费、投资和地产链数据；美国人口普查局将在同日公布6月零售销售。一个看中国内需能否扩散，一个看美国消费能否扛住高利率。',
