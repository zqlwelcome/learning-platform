...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 伯克希尔哈撒韦二季度净利润大幅增长，现金储备有所下降，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 伯克希尔哈撒韦二季度净利润大幅增长，现金储备有所下降；需要成交量继续确认。"
            },
            {
                "label": "宏观",
            ...
            {
                "label": "商品",
                "value": "从美伊紧张局势降级到美日联合干预日元，长期美债收益率“红线”暴露，持续6个月… 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。伯克希尔哈撒韦二季度净利润大幅增长，现金储备有所下降 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：伯克希尔哈撒韦(BRK.A.N)截至6月30日持有的固定收益证券投资公允价值达170.34亿 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。伯克希尔哈撒韦二季度净利润大幅增长，现金储备有所下降 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
