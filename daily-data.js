...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 Anthropic计划IPO前夕寻求增设数十亿美元银行授信，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 Anthropic CEO掷百万美元政治资金 对决OpenAI反监管…；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "1. 称通胀还会进一步降低——特朗普：好消息，民主党造成的通胀已经大幅下降，… 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "道达尔能源：中东冲突推高油价，公司二季度盈利有望提振 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "300亿房企万通发展跨界芯片股价暴涨200%，中报却巨亏近2亿创历史新高 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "Anthropic CEO掷百万美元政治资金 对决OpenAI反监管阵营 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。Anthropic计划IPO前夕寻求增设数十亿美元银行授信 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 1. 称通胀还会进一步降低——特朗普：好消息，民主党造成… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。1. 称通胀还会进一步降低——特朗普：好消息，民主党造成的通胀已经大幅下降，我们还会进一步降 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：旧金山完全无力应对即将来袭的财富海啸 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。Anthropic CEO掷百万美元政治资金 对决OpenAI反监管阵营 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
