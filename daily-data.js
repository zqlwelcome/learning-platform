...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 便宜90%！美国企业偷偷换上中国大模型；需要成交量继续确认。"
            },
            {
                "label": "宏观",
    ...
    "experts": {
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。便宜90%！美国企业偷偷换上中国大模型 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
