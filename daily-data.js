...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 1. 敦促通过《拯救美国法案》——特朗普：昨晚我的演讲获得了很好的评价，…，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 SpaceX洽谈为五角大楼AI计划提供算力支持；需要成交量继续确认。"
            },
            {
                "label": "宏观",
            ...
            {
                "label": "商品",
                "value": "油价大涨！伊朗革命卫队：霍尔木兹海峡已“完全关闭”！伊朗多地传出爆炸声！以军… 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "“越跌越买”！私募一边密集自购，一边连续三周加仓！“优质公司还有广阔空间，仍… 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。1. 敦促通过《拯救美国法案》——特朗普：昨晚我的演讲获得了很好的评价，观众人数众多 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。SpaceX洽谈为五角大楼AI计划提供算力支持 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
