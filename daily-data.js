...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 狂砸8.5万亿！中国AI算力扩容三倍、国产芯片占比要超70%；需要成交量继续确认。"
            },
            {
                "label": "宏观",
            ...
            {
                "label": "中国资产",
                "value": "狂砸8.5万亿！中国AI算力扩容三倍、国产芯片占比要超70% 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。狂砸8.5万亿！中国AI算力扩容三倍、国产芯片占比要超70% 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
