...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "宏观",
                "value": "分析师：沃什杰克逊霍尔讲话或明确美联储应对通胀路径 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
            ...
            {
                "label": "中国资产",
                "value": "曾指点贝森特的德鲁肯米勒直言 政府违背基本面压低收益率终将落败 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 分析师：沃什杰克逊霍尔讲话或明确美联储应对通胀路径 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。分析师：沃什杰克逊霍尔讲话或明确美联储应对通胀路径 可以看，但不能替代财报、负债和自由现金流。",
