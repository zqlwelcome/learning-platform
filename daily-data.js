...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 金十整理：下周重要事件与数据预告——中国一年期LPR将公布；美国核心PC…，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
            ...
            {
                "label": "宏观",
                "value": "金十整理：下周重要事件与数据预告——中国一年期LPR将公布；美国核心PCE数… 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "随着石油价格下跌，押注石油供应过剩的头寸重新成为焦点 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "金十整理：下周重要事件与数据预告——中国一年期LPR将公布；美国核心PCE数… 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。金十整理：下周重要事件与数据预告——中国一年期LPR将公布；美国核心PCE数据来袭；英伟达年度股东大会周… 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 金十整理：下周重要事件与数据预告——中国一年期LPR将公… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。芯片股狂欢周！美股基金流入创新高，日经7万点，韩股一年涨两倍 可以看，但不能替代财报、负债和自由现金流。",
