...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 美股存储芯片股重挫，闪迪跌近11%，马斯克财富一周蒸发8800亿元，黄金…，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
            ...
            {
                "label": "中国资产",
                "value": "据韩联社：韩国互联网门户运营商Naver公司已获得英伟达和美国私募股权公司B… 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "美股牛市四周年近在眼前，美联储会亲手终结吗 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。美股存储芯片股重挫，闪迪跌近11%，马斯克财富一周蒸发8800亿元，黄金突破4050美元，国际油价大跌3… 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 观点综述：SpaceX若100美元或意味AI零估值 欧央… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。纳指领跌，芯片、光通信遭砸盘！闪迪SK海力士大跌超8%，SpaceX再创新低 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：大宗商品综述：布伦特回落 基本金属涨跌不一 金价微升 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
