...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 联合国：今年上半年全球贸易在价格压力上升情况下持续扩张，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 联合国：今年上半年全球贸易在价格压力上升情况下持续扩张；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "Spectra总裁Donnelly：美元在美联储决策日之前有上涨空间 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
            ...
            {
                "label": "中国资产",
                "value": "联合国：今年上半年全球贸易在价格压力上升情况下持续扩张 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "欧盟反垄断监管机构批准派拉蒙(PSKY.O)以1100亿美元收购华纳兄弟探索… 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。联合国：今年上半年全球贸易在价格压力上升情况下持续扩张 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 Spectra总裁Donnelly：美元在美联储决策日之… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：GE Vernova公布最新季度财报后股价走低 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。联合国：今年上半年全球贸易在价格压力上升情况下持续扩张 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
