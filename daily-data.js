...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 挪威主权财富基金或砍掉800亿美元美债持仓 高评级抵押贷款证券料成新宠，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 1. 网信办等七部门：探索算力设施800V高压直流供电架构，推动超百…；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "挪威主权财富基金或砍掉800亿美元美债持仓 高评级抵押贷款证券料成新宠 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "受中东局势紧张影响，油价小幅走高，纳斯达克期货走强 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "2400亿市值PCB龙头，涨停！ 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "1. 网信办等七部门：探索算力设施800V高压直流供电架构，推动超百千瓦单机… 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。挪威主权财富基金或砍掉800亿美元美债持仓 高评级抵押贷款证券料成新宠 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 挪威主权财富基金或砍掉800亿美元美债持仓 高评级抵押贷… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。10年期美债收益率正考验4.8%关口，若持续突破，或波及股市、黄金等资产 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：分析师：尽管SK海力士Q3利润或不及预期 但其盈利轨迹稳固 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。1. 网信办等七部门：探索算力设施800V高压直流供电架构，推动超百千瓦单机柜部署 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
