...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 布伦特维持在每桶90美元上方时，油价通过通胀、消费和企业成本进入宏观框架，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
            ...
            {
                "label": "商品",
                "value": "布伦特维持在每桶90美元上方时，油价通过通胀、消费和企业成本进入宏观框架 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "撤回科创板后分拆再冲港股、关联交易缠身、IPO前夕实控人家族套现超亿元⋯⋯伊… 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。布伦特维持在每桶90美元上方时，油价通过通胀、消费和企业成本进入宏观框架 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 美联储政策其实已经“偏宽松”? 旧金山联储中性利率新模型… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。分析师：美债收益率飙升或冲击亚洲AI牛市 可以看，但不能替代财报、负债和自由现金流。",
