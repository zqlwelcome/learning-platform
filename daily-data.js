...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 美国银行：欧洲股市或因AI不确定性走弱；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "继SK海力士推出回购方案后，三星计划最高向股东返还800亿美元 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
            ...
            {
                "label": "中国资产",
                "value": "美国银行：欧洲股市或因AI不确定性走弱 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 继SK海力士推出回购方案后，三星计划最高向股东返还800… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。美国银行：欧洲股市或因AI不确定性走弱 可以看，但不能替代财报、负债和自由现金流。",
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。美国银行：欧洲股市或因AI不确定性走弱 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
