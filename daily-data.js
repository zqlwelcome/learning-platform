...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 索尼和台积电据悉将投资64亿美元在日本建设图像传感器合资工厂；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "铜价守住14000美元关口，美国利率前景提振金属板块 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "全球央行大手笔增持黄金！低PE+业绩高增长概念股出炉，6股已回撤30%以上 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "全球央行大手笔增持黄金！低PE+业绩高增长概念股出炉，6股已回撤30%以上 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 铜价守住14000美元关口，美国利率前景提振金属板块 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。分析：美日实际利率差距太大 要日元摆脱颓势谈何容易 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：标普500指数近期在科技股带动下频创历史新高，但涨势能否延续将取决于即将公布的美国7月CPI 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。索尼和台积电据悉将投资64亿美元在日本建设图像传感器合资工厂 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
