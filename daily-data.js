...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "宏观",
                "value": "分析：债市压力正在冲击实体经济，华尔街静待沃什表态 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
            ...
            {
                "label": "风险",
                "value": "国内新闻：1. 今冬或形成超强厄尔尼诺事件，大概率为历史最强 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 分析：债市压力正在冲击实体经济，华尔街静待沃什表态 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。国内新闻：1. 今冬或形成超强厄尔尼诺事件，大概率为历史最强 可以看，但不能替代财报、负债和自由现金流。",
