    ...
    return [
        {
            date: '2026-06-23',
            label: '06/23 结果',
            event: '全球6月PMI初值：欧洲修复弱、英国服务收缩',
            region: '全球增长',
            impact: 'medium',
            summary: '结果+市场解读：欧元区综合PMI仍在50下方但跌幅收窄，英国服务PMI降到48.7，说明能源冲击缓和后，制造补库存有支撑，但服务需求还弱。市场会把它解读成“增长不够强、通胀还没彻底退”。',
            thesis: '先改风险偏好和盈利预期，再通过欧洲利率和美元指数影响全球资金。不是单纯衰退，而是弱增长配上仍需防通胀。',
            assets: '欧元、英镑、美元指数、德债和英债、黄金、原油、欧洲银行、奢侈品、港股科技、A股出口链。',
            flow: '热钱会先减少欧洲和英国服务消费风险，保留制造补库存与能源链观察。若欧元走弱、黄金不跌、港股科技承压，说明资金在交易“欧洲需求弱、美元相对硬”。',
            plan: '如果美国PMI也走弱且收益率下行，可观察黄金和科技修复；如果美国PMI价格分项偏强，倾向控制高估值成长和港股高β追涨。',
            plain: '欧洲和英国不是全面崩，但服务业已经让资金变谨慎。'
        },
        {
            date: '2026-06-25',
            label: '06/25',
        ...
        },
        {
            ...
            region: '欧洲利率',
            impact: 'medium',
            summary: '预期窗口：ECB年度央行论坛在6月29日至7月1日举行，7月1日还有欧元区6月通胀初值。6月PMI显示增长仍弱但成本压力缓和，市场会听欧洲央行是否敢软化口径。',
        ...
        },
        {
            ...
            region: '政策风险',
            impact: 'medium',
            summary: '预期窗口：7月初市场会继续盯美国关税豁免、财政谈判和能源运输风险。它们不是单个数据点，但会同时影响企业成本、进口价格、美元避险和商品风险溢价。',
            thesis: '改的是政策预期、通胀预期和地缘风险溢价。关税和能源运输越不确定，企业利润率和通胀路径越难被市场放心定价。',
            assets: '美元、人民币、黄金、原油、航运、出口制造、半导体、汽车链、A股和港股外需板块。',
            flow: '如果关税或能源风险升温，热钱会先买美元、黄金、能源和防御股，撤出出口高β和对估值敏感的科技；如果豁免延长、油价回落，资金才更愿意回补新兴市场和制造链。',
            plan: '如果美元和油价同时上行，倾向降低外需高β和港股弹性追涨；如果美元走弱、油价回落且人民币企稳，可提高出口制造和港股科技观察权重。',
            plain: '政策和油价如果一起变紧，企业成本会上去，资金就会先躲一躲。'
        }
    ];
}
