    ...
    const events = [
        {
            ...
            region: '中国景气',
            impact: 'medium',
            result: '结果+市场解读：制造业PMI回到50.0，生产51.2，但新出口订单48.6、原材料购进价48.6、出厂价49.2。意思是内需有托底，外需和定价权还不够强。',
            core: '交易员核心判断：它主要改的是盈利预期和政策预期。景气线没有塌，但企业议价能力还弱，市场会继续等后续稳增长落地。',
            assets: '资产映射：A股和港股里，工程机械、设备更新、基建链比纯出口链更稳；黑色、有色更多看需求能否继续上修。',
            flow: '热钱路径：资金更愿意留在“政策能托、订单能见度高”的中字头、高端制造、港股央国企；如果出口链走弱而红利继续抗跌，说明钱还在防守里轮动。',
            action: '操作提示：如果后续信用和6月经济数据跟上，倾向关注顺周期和港股估值修复；如果PMI站上50但量价继续弱，别把一次回暖当成全面复苏。',
            plain: '小白翻译：经济不是很差，但也没热到能让所有股票一起涨。',
        },
        {
            date: '2026-06-05',
            label: '06/05',
            ...
            region: '美元利率',
            impact: 'high',
            result: '结果+市场解读：新增非农17.2万，失业率4.3%不变。数据比市场预期强，盘中直接把“今年很快转鸽”的押注往后推，美债收益率和美元偏强，纳指更容易先挨估值压。',
            core: '交易员核心判断：它主要改的是利率预期和风险偏好。就业不软，美联储就没有急着放松的理由。',
            assets: '资产映射：2年和10年美债收益率、美元、黄金、纳指、半导体、港股互联网、A股成长股都会被重新定价。',
            flow: '热钱路径：短线资金会先往美元、短债、现金流稳的大盘股回流；如果你看到2年美债继续上、纳指领跌、黄金承压，就是市场在交易“更久更高”。',
            action: '操作提示：如果后面美国通胀也偏强，倾向减轻高估值成长；如果非农强但随后收益率掉头回落，说明市场开始交易“增长强但通胀可控”，科技可能有二次回拉。',
            plain: '小白翻译：美国工作市场还不差，所以降息这件事没那么快。',
        },
        {
            date: '2026-06-07',
            label: '06/07',
            ...
            region: '原油地缘',
            impact: 'high',
            result: '结果+市场解读：七个核心产油国决定7月再增产18.8万桶/日，同时把总产量框架维持到2026年底。名义上是供给增加，但如果油价不跌反涨，市场交易的就不是供给，而是运输受阻和地缘风险溢价。',
            core: '交易员核心判断：它主要改的是通胀预期、流动性预期和地缘风险溢价。油价一旦高位黏住，全球央行降息空间都会被压。',
            assets: '资产映射：原油、油服、航运、航空、全球通胀交易、美债收益率、黄金，以及A/H能源与化工链都会受影响。',
            flow: '热钱路径：资金可能一边流入能源、军工、商品相关资产，一边撤出对利率最敏感的长久期科技；如果布油站稳而黄金和美元一起偏强，说明市场在同时交易通胀和避险。',
            action: '操作提示：如果油价冲高但很快回落，可把它当作情绪冲击；如果油价高位钝化且运价同步上行，倾向回避高油价受损的消费和航空。',
            plain: '小白翻译：别只看“增产”两个字，关键看油价到底跌不跌。',
        },
        {
            date: '2026-06-10',
            label: '06/10',
            ...
            region: '通胀定价',
            impact: 'high',
            result: '结果窗口：6月10日。非农已经把降息预期压后，这次CPI会决定“高利率更久”是不是要被市场进一步坐实。',
            core: '交易员核心判断：它主要改的是利率预期和流动性预期。CPI如果再硬，美联储6月后的语言会更难转鸽。',
            assets: '资产映射：2年美债、美元、黄金、纳指、半导体、比特币、港股互联网、A股AI链都会跟着波动。',
            flow: '热钱路径：如果CPI高于预期且2年美债继续冲高，资金会从长久期资产撤向美元、短债和防御；如果CPI回落但油价没再推高，热钱会先回科技和黄金。',
            action: '操作提示：如果数据强于预期，倾向减轻高估值成长股；如果通胀回落且收益率下行，可关注黄金和科技反弹，但先看是否是一日行情。',
            plain: '小白翻译：这份通胀数据会决定“贵的成长股还能不能继续贵”。'
        },
        {
            date: '2026-06-10',
            label: '06/10',
            ...
            region: '中国价格',
            impact: 'medium',
            result: '结果窗口：6月10日。市场要看内需是不是在慢慢抬头，还是仍旧停留在“有政策、没价格”的状态。',
            core: '交易员核心判断：它主要改的是盈利预期和政策预期。CPI太弱说明消费修复不够，PPI太弱说明上游到制造业的利润传导还没打通。',
            assets: '资产映射：A股消费、白酒、家电、顺周期、煤化工、有色，港股内需和平台股，人民币汇率都会受影响。',
            flow: '热钱路径：如果CPI/PPI同步改善，资金更容易回流内需修复和顺周期；如果继续偏弱，钱会更愿意待在高股息、央国企和政策主题里。',
            action: '操作提示：如果价格数据改善但成交量不跟，先别追；如果价格修复叠加人民币企稳，可留意港股消费和A股顺周期修复。',
            plain: '小白翻译：这不是看“物价涨不涨”这么简单，而是看中国企业赚钱会不会更容易。'
        },
        {
            date: '2026-06-16',
            label: '06/16',
            ...
            region: '中国增长',
            impact: 'high',
            result: '结果窗口：6月16日。这里比单独看CPI更重要，因为它直接回答消费、制造、地产到底谁在拖、谁在扛。',
            core: '交易员核心判断：它主要改的是盈利预期和政策预期。工业和零售强，说明稳增长开始传导到企业收入；地产继续弱，说明信用修复还不扎实。',
            assets: '资产映射：A股可选消费、家电、建材、机械、银行、地产链，港股内房、物管、消费互联网，人民币和国债也会受影响。',
            flow: '热钱路径：如果工业和零售走强、地产止跌，资金会从纯防御转向顺周期和消费修复；如果只有工业强、消费和地产弱，钱会更偏制造业龙头和红利。',
            action: '操作提示：如果数据改善但地产仍拖后腿，倾向只做结构而不做全面进攻；如果消费、工业、地产一起改善，再考虑提高中国风险资产暴露。',
            plain: '小白翻译：这一天能看出中国经济是在“真修复”还是“局部回暖”。'
        },
        {
            date: '2026-06-15',
            label: '06/15-16',
            ...
            region: '日元套息',
            impact: 'medium',
            result: '结果窗口：会议在6月15日至16日，相关材料按日程在6月19日继续释放。核心不是会不会立刻大动作，而是日债购买、通胀判断和日元态度会不会让套息交易降温。',
            core: '交易员核心判断：它主要改的是全球流动性预期和风险偏好。日元若明显转强，全球靠低息融资的风险仓位会被迫收缩。',
            assets: '资产映射：日元、日债、纳指、亚洲成长股、港股科技、比特币和黄金都会受情绪与流动性影响。',
            flow: '热钱路径：如果日元突然走强、日债收益率抬升、亚洲高贝塔先跌，说明资金在拆日元套息；如果会后日元反而走弱，风险资产会先松一口气。',
            action: '操作提示：如果日本央行口风偏鹰，倾向降低高杠杆高波动仓位；如果表态温和且美元利率没再上冲，亚洲成长资产有望迎来技术性反弹。',
            plain: '小白翻译：日本一收水，全球很多爱冒险的钱就会先缩手。'
        },
        {
            date: '2026-06-16',
            label: '06/16-17',
            ...
            region: '全球定价锚',
            impact: 'high',
            result: '结果窗口：6月16日至17日。这是未来两周最重要的全球资产定价点，重点不在“按不按兵不动”，而在点阵图、通胀表述和鲍威尔是否承认降息要更晚。',
            core: '交易员核心判断：它主要改的是利率预期、流动性预期和风险偏好，是全球资产的总开关。',
            assets: '资产映射：美债收益率、美元、黄金、原油、纳指、罗素、A股成长、港股科技、新兴市场汇率都会被重定价。',
            flow: '热钱路径：偏鹰时，资金会回流美元、短债、能源和防御；偏鸽时，黄金、科技、港股、成长风格和新兴市场更容易同步受益。真正的确认信号是美元和2年美债是否同向走。',
            action: '操作提示：如果点阵图上修、鲍威尔偏鹰，倾向保守处理成长仓位；如果通胀措辞缓和且收益率下行，可关注黄金、科技和港股弹性，但最好等会后第一个完整交易日再确认。',
            plain: '小白翻译：这次会议决定接下来全球市场更像“抢反弹”还是“先防守”。'
        }
    ];
