...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 决策日指南：日本央行料维持政策不变 植田和男重回聚光灯下，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 AI存储芯片短缺推动三星芯片利润激增逾250倍；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "7月30日隔夜要闻：美股大幅收跌道指重挫1100点 油价大幅反弹 美联储利率… 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
            ...
            {
                "label": "中国资产",
                "value": "兆易创新董事长提议公司回购10亿至20亿元A股 拟增持不低于10亿元股份 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "决策日指南：日本央行料维持政策不变 植田和男重回聚光灯下 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。决策日指南：日本央行料维持政策不变 植田和男重回聚光灯下 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 7月30日隔夜要闻：美股大幅收跌道指重挫1100点 油价… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。狂揽80亿美元估值，黑石推动三明治连锁店Jersey Mike's冲刺IPO 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：英伟达合作伙伴ChipAgents扩大融资规模，借助AI加速芯片开发 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。AI存储芯片短缺推动三星芯片利润激增逾250倍 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
