...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 1. 黄仁勋出手安抚AI算力市场，黄仁勋联合华尔街巨头背书AI算力；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "高盛：市场对美联储加息押注过于鹰派 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "黄金再触4400美元关口，下一阶段靠什么上涨？ 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 高盛：市场对美联储加息押注过于鹰派 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。1. 黄仁勋出手安抚AI算力市场，黄仁勋联合华尔街巨头背书AI算力 可以看，但不能替代财报、负债和自由现金流。",
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。1. 黄仁勋出手安抚AI算力市场，黄仁勋联合华尔街巨头背书AI算力 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
