...
const _EMBEDDED_DATA = {
  "mood": {
    ...
    "dimensions": [
      {
        "label": "📈 趋势",
        "value": "AI芯片股反弹引领纳斯达克上涨，但道指下跌，市场呈现明显的结构性分化。特朗普与股市挂钩的言论增加了短期波动性。SK海力士巨额定增表明AI长期趋势未改，但短期资金已出现分歧。"
      },
      {
        "label": "💰 资金",
        "value": "对冲基金连续第四周抛售芯片股，显示聪明钱在高位兑现利润。同时，AI相关新股IPO（SK海力士）吸引巨额资金，表明长期资本仍在涌入。资金从高估值科技股向周期或价值板块轮动的迹象初现。"
      },
      {
        "label": "🌍 地缘",
        "value": "特朗普重返市场焦点，其政策不确定性（如关税、贸易）仍是风险源。英国监管警告AI军备竞赛，预示全球科技监管趋严，可能增加行业成本与合规风险。"
      },
      {
        "label": "🏭 热点",
        "value": "AI芯片（SK海力士、美光）仍是绝对热点，但短期波动剧烈。新能源汽车（Rivian vs 特斯拉）竞争白热化，市场关注点从概念转向销量和盈利。国际旅游因气候异常而出现季节性错位，成为非典型消费热点。"
      },
      {
        "label": "😊 情绪",
        "value": "散户投资者在特朗普概念股和加密货币上亏损严重（福布斯报道），情绪受损。但AI股票反弹又带动了部分乐观情绪。整体情绪复杂，贪婪与恐惧并存，专业投资者与散户之间的预期差加大。"
      },
      {
        "label": "🏦 宏观",
        "value": "美国经济数据分化，股市表现与宏观经济关联度降低，更多受政策和事件驱动。英国监管态度预示全球宏观审慎政策可能收紧。高利率环境下，企业融资成本压力持续，但AI相关投资仍被赋予高容忍度。"
      }
    ],
    "summary": "今日市场情绪呈现显著分化：AI长期叙事依然强劲（SK海力士IPO、芯片反弹），但短期资金（对冲基金）已开始获利了结并寻求轮动。特朗普的政治影响和散户的惨痛亏损加剧了市场的不确定性。整体情绪从狂热转向谨慎乐观，市场正经历从“故事”到“业绩”的验证期。"
  },
  "experts": {
    "templeton": {
      "insight": "当前市场极度悲观与乐观并存，这正是逆向投资的温床。散户在特朗普股和加密货币上血亏（新闻7），而机构却在AI高位抛售（新闻5），这形成了典型的人弃我取时机。SK海力士的巨额IPO（新闻1）是AI泡沫的顶点信号吗？不，它更像是全球资金向核心生产力转移的确认。当所有人都在追逐AI芯片时，真正的价值可能藏在被冷落的传统行业或国际旅游（新闻10）等非共识领域。全球监管的‘军备竞赛’（新闻9）反而会淘汰劣质公司，为长期价值创造者铺路。",
      "action": "卖出短期涨幅过大的AI概念股，开始分批建仓受冷落的、有稳定现金流的传统工业股和国际旅游相关资产。利用市场对特朗普的过度反应，逆向买入被错杀的基本面稳健公司。"
    },
    "buffett": {
      "insight": "今日新闻的核心是企业是否拥有持久护城河。SK海力士（新闻1）和美光（新闻3）的反弹表明AI芯片需求真实，但巨额资本开支和价格战是长期隐忧，这不像喜诗糖果那样有定价权。特朗普敲钟（新闻2）是政治秀，但股市长期回报必然回归企业盈利。对冲基金抛售芯片（新闻5）和散户在‘特朗普股’上亏钱（新闻7）都说明，追逐噪音和概念无法带来长期复利。我更关注Rivian和特斯拉的竞争（新闻8），谁能真正以合理价格造出消费者离不开的电动车，谁才值得持有。英国监管（新闻9）是好消息，它避免了金融系统因AI过热而崩溃。",
      "action": "无视短期波动，继续持有或增持具有强大品牌、低资本需求和稳定现金流的企业。对AI芯片股保持观望，等待其资本回报率（ROIC）超过资本成本的证据。绝不参与任何基于政治人物或加密货币的投机。"
    },
    "munger": {
      "insight": "这组新闻充满了愚蠢和矛盾。对冲基金在AI上追涨杀跌（新闻5），散户在特朗普概念股上赔光（新闻7），这就是典型的‘旅鼠效应’。SK海力士要融280亿（新闻1），这恰恰说明这个行业有多烧钱，未来必然有惨烈的价格战。英国监管说AI是‘军备竞赛’（新闻9），没错，但最后赢家通吃，大部分参与者都是炮灰。人们因为热浪去旅游（新闻10）？这不过是人类愚蠢行为的又一个例子。投资不是比谁更聪明，而是比谁更少犯蠢。避开所有复杂、高杠杆、未来现金流不确定的东西。",
      "action": "清仓所有半导体和AI概念股。不要碰任何与加密货币或特朗普有关的资产。持有现金或买入简单的、可理解的、有长期竞争优势的消费品公司。等待AI泡沫破裂后再寻找真正的便宜货。"
    },
    "duan": {
      "insight": "今天新闻里，我最关注的是SK海力士的IPO（新闻1）和对冲基金卖芯片（新闻5）。这说明什么？好公司（海力士）在融资扩张，而投机者（对冲基金）在害怕。这就是好生意和坏生意的区别。AI是未来，但买股票要看价钱。美光反弹（新闻3）说明好公司跌多了就会有人买。Josh Brown说的板块轮动（新闻6）有道理，但如果你持有的公司足够好，为什么要换？就像我买苹果，不会因为今天科技股跌了就去买钢铁。特朗普敲钟（新闻2）就是娱乐新闻，跟投资没关系。投资要找那些你愿意拿着十年的公司，而不是看新闻做短线。",
      "action": "如果持有AI龙头（如英伟达、台积电的上下游），只要公司基本面没变坏，就继续持有，不要被对冲基金的抛售吓到。关注SK海力士的招股书，如果价格合理，可以考虑申购。远离特朗普概念股和加密货币，那是在赌博。"
    }
  },
  "updateTime": "2026-07-07 01:01",
  "generatedAt": "2026-07-07 01:01"
};;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
    ...
    return [
        {
            date: '2026-07-01',
            label: '07/01 结果',
            event: '中美6月制造业PMI：生产扩张，价格和结构仍分化',
            region: '全球制造',
            impact: 'high',
            summary: '结果+市场解读：中国官方制造业PMI升至50.3，生产51.4、新订单51.2，但小企业48.2、就业48.5，说明AI和出口制造偏强，内需并未全面修复。美国ISM制造业为53.3，连续第六个月扩张，但价格指数仍高达73。市场交易的是“制造有韧性、降息空间受通胀约束”。',
            thesis: '改的是盈利预期、商品需求和利率预期。中国数据支持结构性制造行情；美国订单强、价格高，则会把长端收益率和实际利率维持在高位。',
            assets: '铜、原油、美债收益率、美元、纳指、A股高端制造、AI硬件、出口链、港股工业、内需消费。',
            flow: '资金更愿意留在AI硬件、机械和有订单的出口链，不会因为总量回到50以上就全面买消费地产。若铜和制造龙头强、内需板块弱，说明结构交易仍在；若美债收益率上行，则高估值成长会被压估值。',
            plan: '如果中国订单继续改善且人民币走稳，可关注高端制造和出口链；如果美国价格分项继续高位并推升收益率，倾向降低高估值科技追涨，不把制造扩张直接等同于全面风险偏好回升。',
            plain: '工厂比上月忙了，但赚钱机会仍集中在少数出口和AI链，不是所有股票一起好。'
        },
        {
            date: '2026-07-02',
            label: '07/02 结果',
            event: '美国6月非农：新增5.7万，前值大幅下修',
            region: '美国就业',
            impact: 'high',
            summary: '结果+市场解读：非农仅增5.7万，低于市场预期；4月和5月合计下修7.4万。失业率降至4.2%，但时薪同比仍有3.5%。数据削弱加息押注，2年美债收益率、美元回落，黄金上涨；科技反应没有黄金干净，因为芯片自身估值和盈利分化仍在。',
            thesis: '先改利率预期和美元流动性，再改风险偏好。就业降温利多债券和黄金，但工资仍有粘性，不能直接推导为快速降息。',
            assets: '2年和10年美债、美元、黄金、纳指、半导体、比特币、港股科技、离岸人民币。',
            flow: '资金从美元和加息交易回补债券、黄金与部分成长股。若2年收益率继续下行、美元走弱且黄金保持强势，说明宽松交易延续；若科技跟不上，说明资金只买利率对冲，不愿扩大风险预算。',
            plan: '如果后续CPI也降温且2年收益率继续回落，可关注黄金、债券和科技修复；如果工资与服务通胀仍强、收益率重新上行，倾向降低高估值成长追涨。',
            plain: '美国招聘明显慢了，市场先松一口气，但工资还不够凉，美联储不会立刻转鸽。'
        },
        {
            date: '2026-07-06',
            label: '07/06',
            event: '美国6月ISM服务业：就业降温后看价格粘性',
            region: '美国服务',
            impact: 'high',
            summary: '预期窗口：ISM服务业因独立日假期顺延至7月6日。非农已经显示招聘放慢，市场会重点看服务活动、就业和价格分项，判断“弱就业”能否进一步变成“低通胀”。',
            thesis: '改的是利率预期和风险偏好。服务价格比制造价格更贴近核心通胀；活动弱、价格也降，才是真正利多降息交易。',
            assets: '2年美债、美元、黄金、纳指、软件、消费、银行、港股科技、人民币。',
            flow: '若活动与价格同时降温，资金会继续从美元和现金回补债券、黄金、科技；若活动弱但价格高，资金会转向黄金和防御，科技未必受益。先看2年收益率和美元是否确认。',
            plan: '如果价格分项明显回落且收益率下行，可关注黄金和科技反弹；如果价格仍高并推升收益率，倾向控制高估值成长和港股高β仓位。',
            plain: '招聘慢不等于物价马上降，今晚要看美国服务业还会不会继续涨价。'
        },
        {
            date: '2026-07-07',
            label: '07/07',
            event: '中国6月外储 + 美国3年期国债拍卖',
            region: '人民币/流动性',
            impact: 'medium',
            summary: '预期窗口：外汇局按日程公布6月官方储备资产；美国财政部拍卖3年期国债。外储不只看增减，还要区分美元折算和真实跨境压力；短债拍卖则检验市场对美联储路径的定价。',
            thesis: '改的是人民币预期、跨境流动性和短端利率。外储稳定能降低人民币风险溢价，拍卖需求弱则会抬高融资成本。',
            assets: '离岸人民币、A股、港股、美元、3年美债、银行、黄金、高股息。',
            flow: '若人民币走稳、外储稳定且北向风险偏好改善，资金更容易回补港股和A股β；若拍卖尾部弱、短端收益率上行，全球资金会留在美元现金，压制新兴市场。',
            plan: '如果外储稳定且人民币升值，可提高港股和A股顺周期观察权重；如果美债拍卖偏弱、美元同步走强，倾向降低新兴市场高β暴露。',
            plain: '一边看人民币底气，一边看美国借短钱贵不贵。'
        },
        {
            date: '2026-07-08',
            label: '07/08',
        ...
        },
        {
            date: '2026-07-17',
            label: '07/17-07/20',
            event: '美国工业产出/住房 + 中国LPR窗口',
            region: '增长/政策',
            impact: 'medium',
            summary: '预期窗口：7月17日美国公布工业产出和新屋开工，7月20日进入中国LPR报价窗口。前者检验高利率对实体投资和地产的压力，后者看国内宽信用是否进一步发力。',
            thesis: '改的是增长、盈利和政策预期。美国实体走弱会压周期需求；中国LPR若下调，需看银行、地产销售和人民币是否配合，才能判断政策传导。',
            assets: '美债、美元、铜、原油、美国工业和住宅链、A股银行地产、港股内房、消费、人民币。',
            flow: '若美国工业与住房转弱，资金偏债券和防御；若中国LPR下调且人民币稳定、地产成交改善，资金可能回补银行地产和顺周期。只有降息没有成交，热钱通常只做短线。',
            plan: '如果美国数据弱且信用利差稳定，可关注债券；如果中国LPR下调并出现量价确认，可提高顺周期观察权重；如果人民币承压或地产成交无改善，倾向不追政策脉冲。',
            plain: '月底前最后看两件事：美国高利率伤得多深，中国降成本能不能真的带来借钱和买房。'
        }
    ];
}
