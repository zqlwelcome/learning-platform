...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "宏观",
                "value": "贝森特国债回购带来的行情落幕，长久期美债收益率再度上行 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 贝森特国债回购带来的行情落幕，长久期美债收益率再度上行 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
