...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "商品",
                "value": "易方达原油（QDII-LOF-FOF）8月31日暂停赎回业务 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "易方达原油（QDII-LOF-FOF）8月31日暂停赎回业务 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：易方达原油（QDII-LOF-FOF）8月31日暂停赎回业务 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
