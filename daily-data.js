...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "商品",
                "value": "金十整理：下周重要事件与数据预告——周三美国CPI数据重磅来袭；国内成品油将… 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
            ...
            {
                "label": "风险",
                "value": "美加利福尼亚州推出1.35亿美元新能源汽车购车补贴政策 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        ...
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。非农降温后，美股计价的“鹰派风险”如何被重新定价？ 可以看，但不能替代财报、负债和自由现金流。",
