...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 哈佛大学重仓SpaceX，22亿美元投资彰显长期布局，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 芯片股反弹难消忧虑，韩国市场做空规模持续攀升；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "哈佛持有22亿美元SpaceX股权 多所美国高校基金斩获巨额回报 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "哈佛大学重仓SpaceX，22亿美元投资彰显长期布局 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
            ...
            {
                "label": "风险",
                "value": "国内新闻：1. 1至7月全国铁路发送旅客28亿人次 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。哈佛大学重仓SpaceX，22亿美元投资彰显长期布局 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 哈佛持有22亿美元SpaceX股权 多所美国高校基金斩获… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。芯片股反弹难消忧虑，韩国市场做空规模持续攀升 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：国内新闻：1. 1至7月全国铁路发送旅客28亿人次 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。芯片股反弹难消忧虑，韩国市场做空规模持续攀升 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
