...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 多家上市公司回应稳定股价相关举措，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
            ...
            {
                "label": "宏观",
                "value": "1. 称“完全不在乎”伊朗暂停履行临时协议——据NewsNation：特朗普… 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "多家上市公司回应稳定股价相关举措 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
            ...
            {
                "label": "风险",
                "value": "1. 称“完全不在乎”伊朗暂停履行临时协议——据NewsNation：特朗普… 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。多家上市公司回应稳定股价相关举措 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 1. 称“完全不在乎”伊朗暂停履行临时协议——据News… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
