...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "宏观",
                "value": "黄金创下七个月最佳单周表现 迈克・库为何继续加仓黄金 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 黄金创下七个月最佳单周表现 迈克・库为何继续加仓黄金 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。大摩启动1.5万亿美元美国创新基础设施计划 聚焦AI等前沿技术 可以看，但不能替代财报、负债和自由现金流。",
