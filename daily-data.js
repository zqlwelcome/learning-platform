...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 大宗商品综述：油价大幅反弹 铜价走低 金价涨幅收窄，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
            ...
            {
                "label": "中国资产",
                "value": "大宗商品综述：油价大幅反弹 铜价走低 金价涨幅收窄 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "美国总统特朗普：有没有人知道美国最高法院在出生公民权和关税问题上的负面裁决给… 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。大宗商品综述：油价大幅反弹 铜价走低 金价涨幅收窄 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：7月30日美股成交额前20：SK海力士利润增长低于预期，将扩大资本开支 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
