...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "中国资产",
                "value": "粮食危机要来了？ 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：美债回购额度翻倍，长端收益率低头，压在黄金头顶的“大山”要挪了？真正起作用的不是流动性，而是 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
