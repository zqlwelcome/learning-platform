...
const _EMBEDDED_DATA = {
  "mood": {
    ...
    "dimensions": [
      {
        "label": "📈 趋势",
        "value": "科技股领跌，纳斯达克期货下滑，三星业绩引发AI芯片担忧，市场出现从科技向能源、消费等冷门板块轮动的迹象。"
      },
      {
        "label": "💰 资金",
        "value": "资金从高估值科技股流出，转向防御性板块和能源股。Rivian融资稀释股价，显示成长股融资环境趋紧。Alarum暴跌反映小盘股风险。"
      },
      {
        "label": "🌍 地缘",
        "value": "特朗普与股市挂钩言论增加政策不确定性；中美AI模型竞争加剧，中国AI公司获美企订单，地缘科技博弈持续。"
      },
      {
        "label": "🏭 热点",
        "value": "AI芯片板块（英伟达、三星）成为波动核心；中国AI模型崛起；奢侈品版权纠纷；新能源汽车融资困难。"
      },
      {
        "label": "😊 情绪",
        "value": "市场情绪复杂，特朗普唱多股市与科技股实际抛售形成反差，投资者对AI泡沫和估值过高的担忧上升。"
      },
      {
        "label": "🏦 宏观",
        "value": "油价上涨带来通胀隐忧；三星财报虽好但未能提振信心，表明市场对科技盈利可持续性存疑，宏观环境支撑轮动。"
      }
    ],
    "summary": "今日市场情绪谨慎偏空，科技股抛售主导，资金从AI芯片等热门板块撤出，转向冷门防御领域。特朗普的乐观言论未能抵消对AI盈利和地缘风险的担忧，市场处于风格切换的震荡期。"
  },
  "experts": {
    "templeton": {
      "insight": "市场悲观时正是寻找极度低估机会的良机。当前科技股抛售源于对AI短期过热的恐惧，但三星创纪录利润证明AI需求真实。中国AI模型崛起可能颠覆成本结构，为投资者提供新洼地。我关注那些被错杀的、具有全球竞争力的科技股，以及因恐慌而超跌的资产，如Alarum事件中的非核心业务。",
      "action": "建议在市场恐慌中分批买入被错杀的优质科技股，重点关注中国AI模型相关公司及因短期利空暴跌但基本面扎实的个股。"
    },
    "buffett": {
      "insight": "市场短期是投票机，长期是称重机。今日科技股下跌反映的是情绪而非价值。特朗普将股市与政治挂钩是危险信号，但优质企业如英伟达的护城河依然深厚。我不追逐热点，而是关注那些有持续现金流、低负债且被误判的公司。Rivian融资稀释股东权益，不符合我的安全边际原则。",
      "action": "保持耐心，不追高AI泡沫，等待科技龙头出现合理估值。增持具有垄断地位和稳定现金流的消费或能源股，远离高负债融资企业。"
    },
    "munger": {
      "insight": "人们总在过度乐观和过度悲观间摇摆。三星业绩好却引发抛售，说明市场已陷入非理性。AI芯片担忧被夸大，但中国AI模型的进步是真实威胁。我讨厌复杂且高估的生意，如Rivian的持续烧钱模式。Louis Vuitton的版权案例提醒投资者，品牌壁垒才是长期竞争优势。",
      "action": "避免参与热门科技股的投机，专注于具有持久品牌和定价权的公司。减持高估值AI概念股，增持版权优势明显的奢侈品或消费龙头。"
    },
    "duan": {
      "insight": "好生意、好管理、好价格，三者缺一不可。今天科技股波动是市场在挤泡沫，但像英伟达这样的公司，只要AI需求长期存在，短期回调就是买入机会。中国AI公司能拿到美国订单，说明技术实力被认可，值得关注。我不喜欢Rivian这种需要不断融资才能活的公司，这不符合好生意的标准。",
      "action": "逢低加仓英伟达等AI硬件龙头，同时关注在美获得客户的中国AI模型公司。坚决回避融资频繁、现金流为负的成长股。"
    }
  },
  "updateTime": "2026-07-08 00:41",
  "generatedAt": "2026-07-08 00:41"
};;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
