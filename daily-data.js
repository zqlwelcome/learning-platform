...
const _EMBEDDED_DATA = {
    ...
    "experts": {
        ...
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。7月CPI预期小幅回落，花旗与美银对9月加息前景存在分歧 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：一边买黄金，一边买美股 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
