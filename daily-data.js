...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 美股周二午盘走高，道指因强劲财报飙升600点，软件股反弹助力纳指转涨，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 能源价格走高叠加AI资本开支热潮，美联储与沃什陷入政策两难；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "宏观看客：万言万当不如一默 沃什时代的美联储更难捉摸 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
            ...
            {
                "label": "风险",
                "value": "Kalshi预判：Meta财报电话会主推智能眼镜，回避社交媒体监管政策话题 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。美股周二午盘走高，道指因强劲财报飙升600点，软件股反弹助力纳指转涨 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 宏观看客：万言万当不如一默 沃什时代的美联储更难捉摸 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。Kalshi预判：Meta财报电话会主推智能眼镜，回避社交媒体监管政策话题 可以看，但不能替代财报、负债和自由现金流。",
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。能源价格走高叠加AI资本开支热潮，美联储与沃什陷入政策两难 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
