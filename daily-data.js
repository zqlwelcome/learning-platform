...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "中国资产",
                "value": "公募股权变更再添一例，万联证券拿下长安基金控股权 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        ...
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。公募股权变更再添一例，万联证券拿下长安基金控股权 可以看，但不能替代财报、负债和自由现金流。",
