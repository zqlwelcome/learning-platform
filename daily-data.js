...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 美国股指期货小幅走高 闪迪、美光等盘前上扬，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。美国股指期货小幅走高 闪迪、美光等盘前上扬 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：法兴银行：美国数据促使美元看涨投机押注减少 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
