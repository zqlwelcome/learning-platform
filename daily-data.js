...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "宏观",
                "value": "三井住友：财政纪律与日本央行加息是抑制日元疲软的关键 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 三井住友：财政纪律与日本央行加息是抑制日元疲软的关键 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。央行主管媒体：谐音梗怎能炒出真收益 可以看，但不能替代财报、负债和自由现金流。",
