...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "宏观",
                "value": "在中东供应干扰担忧加剧之际油价上涨 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "在中东供应干扰担忧加剧之际油价上涨 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "A股上市银行首批半年度业绩揭晓 板块估值修复可期 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 在中东供应干扰担忧加剧之际油价上涨 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。A股上市银行首批半年度业绩揭晓 板块估值修复可期 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：7月22日美股成交额前20：美光市值重返万亿美元之上 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
