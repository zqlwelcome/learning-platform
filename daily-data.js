...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 科技巨头重燃芯片股希望，美债会成为反弹绊脚石吗？；需要成交量继续确认。"
            },
            {
                "label": "宏观",
            ...
            {
                "label": "中国资产",
                "value": "出清行业乱象 私募监管函密集落地 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "出清行业乱象 私募监管函密集落地 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：科技巨头重燃芯片股希望，美债会成为反弹绊脚石吗？ 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。科技巨头重燃芯片股希望，美债会成为反弹绊脚石吗？ 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
