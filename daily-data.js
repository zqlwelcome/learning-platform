...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 美财政部拟将回购规模扩大一倍至40亿美元，沃什推动减少政策会议次数，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 美财政部拟将回购规模扩大一倍至40亿美元，沃什推动减少政策会议次数；需要成交量继续确认。"
            },
            {
                "label": "宏观",
            ...
            {
                "label": "风险",
                "value": "美财政部拟将回购规模扩大一倍至40亿美元，沃什推动减少政策会议次数 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。美财政部拟将回购规模扩大一倍至40亿美元，沃什推动减少政策会议次数 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 特朗普抱怨美联储利率政策，称美国应支付低得多的利率 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。8月20日隔夜要闻：美股转涨 油价升至三周高点 金价大涨 特朗普抱怨联储利率政策 美政府债务突破40万亿美元 可以看，但不能替代财报、负债和自由现金流。",
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。美财政部拟将回购规模扩大一倍至40亿美元，沃什推动减少政策会议次数 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
