...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 曾指点贝森特的德鲁肯米勒直言 政府违背基本面压低收益率终将落败，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 邢自强：美债利率飙升不是危机，AI投资不会撞墙，但聪明钱正从港股流向…；需要成交量继续确认。"
            },
            {
                "label": "宏观",
            ...
            {
                "label": "商品",
                "value": "花旗上调金价短期目标至4800美元 投机行情面临回调风险 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "邢自强：美债利率飙升不是危机，AI投资不会撞墙，但聪明钱正从港股流向这里 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "美监管机构传唤华尔街大行 调查暴亏的AI对冲基金Situational Aw… 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。曾指点贝森特的德鲁肯米勒直言 政府违背基本面压低收益率终将落败 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 摩根士丹利：美财政部一般账户可提供800亿至2000亿美… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。澳洲联储称银行体系准备金仍高于潜在需求 可以看，但不能替代财报、负债和自由现金流。",
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。邢自强：美债利率飙升不是危机，AI投资不会撞墙，但聪明钱正从港股流向这里 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
