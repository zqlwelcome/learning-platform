...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "商品",
                "value": "分析师：澳洲联储料鹰派按兵不动，警惕持续通胀压力 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
    ...
    "experts": {
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：马斯克或采用FEL技术挑战EUV光刻机 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
