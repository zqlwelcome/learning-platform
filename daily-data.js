...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 金十数据整理：每日科技要闻速递（6月26日）；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "纽约联储主席威廉姆斯表示，美国通胀仍明显高于2%目标，但当前利率政策足以继续… 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
            ...
            {
                "label": "中国资产",
                "value": "瑞银资产管理：央行将债券收益率上升视为首要风险 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "纽约联储主席威廉姆斯表示，美国通胀仍明显高于2%目标，但当前利率政策足以继续… 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 纽约联储主席威廉姆斯表示，美国通胀仍明显高于2%目标，但… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。金十数据整理：每日科技要闻速递（6月26日） 可以看，但不能替代财报、负债和自由现金流。",
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。金十数据整理：每日科技要闻速递（6月26日） 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
