...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 北京亦庄发布全国首个AI4Chip专项政策；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "美元受债务担忧压制，徘徊于数月低点 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "大摩警告油价再飙升或冲击美股，建议增持能源股对冲 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
            ...
            {
                "label": "风险",
                "value": "北京亦庄发布全国首个AI4Chip专项政策 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 美元受债务担忧压制，徘徊于数月低点 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。北京亦庄发布全国首个AI4Chip专项政策 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
