...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 本周市场的“核心逻辑”：美联储9月不加息了？，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。本周市场的“核心逻辑”：美联储9月不加息了？ 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 本周市场的“核心逻辑”：美联储9月不加息了？ 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。利好来了！600406，最高10亿元！又一批A股公司，宣布回购 可以看，但不能替代财报、负债和自由现金流。",
