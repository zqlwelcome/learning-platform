    ...
    return [
        {
            date: '2026-06-23',
            label: '06/23 结果',
            event: '全球6月PMI初值 + 科技股和半导体回撤',
            region: '全球增长',
            impact: 'high',
            summary: '结果+市场解读：美国S&P综合PMI升到52.2，制造产出很强，但就业分项转弱、企业仍抱怨高价格和高利率。欧元区综合PMI升到49.5但仍收缩，英国服务PMI跌到48.7，日本制造和服务同步回暖但成本压力上升。市场同日卖出科技和半导体，交易的是“增长没塌、通胀没退、估值太贵”。',
            thesis: '改的是风险偏好、盈利预期和利率敏感度。制造补库存托住增长，但服务和就业没有同步变强，长久期科技最怕收益率继续高位。',
            assets: '2年和10年美债、美元、日元、黄金、原油、纳指、半导体、港股科技、A股出口链和机器人链。',
            flow: '热钱会把一部分仓位从高估值AI链、港股高β和欧洲消费撤出，转去美元现金、短债、黄金和业绩确定性更强的硬件龙头。若美元走强、半导体放量跌、黄金抗跌，说明市场仍在降风险预算。',
            plan: '如果后续PCE或非农继续推高收益率，倾向降低高估值成长追涨；如果收益率回落且科技止跌放量，可只看反弹确认，不提前重仓。',
            plain: '经济还在转，但钱开始嫌科技太贵，先看利率脸色。'
        },
        {
            date: '2026-06-24',
            label: '06/24',
            ...
            flow: '如果大型银行资本消耗小，热钱可能回补金融、价值和高股息；如果压力情景下资本下降超预期，资金会转向短债、美元和防御股，信用利差走阔就是预警。',
        ...
        },
        {
            ...
            region: '美国通胀',
            impact: 'high',
            summary: '预期窗口：BEA将在6月25日同时公布Q1 GDP三次估计和5月个人收入支出。Q1二次估计为1.6%，4月PCE同比已到3.8%，所以市场真正盯的是能源和服务价格有没有继续传导。',
            thesis: '先改利率预期和美元流动性，再改科技股、黄金和人民币资产定价。GDP验证经济韧性，PCE决定美联储能不能继续偏鹰。',
        ...
        },
        {
            ...
            region: '欧洲利率',
            impact: 'medium',
            summary: '预期窗口：ECB年度央行论坛在6月29日至7月1日举行，7月1日还有欧元区6月通胀初值。5月欧元区通胀升到3.2%，能源和服务价格仍是焦点，央行讲话会决定市场是否延长高利率交易。',
        ...
        },
        {
            date: '2026-07-01',
            label: '07/01',
            event: '全球制造数据日：RatingDog PMI + ISM制造业 + 日本短观 + 欧元区CPI',
            region: '全球制造',
            impact: 'high',
            summary: '预期窗口：中国私营制造业PMI、美国ISM制造业、日本短观和欧元区6月CPI同日接力。RatingDog 5月仍在51.8，美国ISM 5月升到54，欧元区5月通胀为3.2%，日本还要看企业是否能承受更高成本和更强日元。',
        ...
        },
        {
            date: '2026-07-03',
            label: '07/03-07/07',
            event: '美国独立日休市 + 短端国债供给',
            region: '美元流动性',
            impact: 'medium',
            summary: '预期窗口：美国7月3日因独立日假期休市，非农后先进入薄盘；7月6日至7日又有短端国库券和3年期美债拍卖。重磅数据、低流动性和供给叠加，会检验美元现金需求是否继续紧。',
        ...
        },
        {
            ...
            region: '美国服务通胀',
            impact: 'high',
            summary: '预期窗口：ISM日程显示6月服务业PMI将在7月6日公布。服务业比制造业更贴近工资、租金和核心通胀，所以它会影响7月美联储会议前的最终利率定价。',
        ...
        },
        {
            ...
            region: '美元利率',
            impact: 'high',
            summary: '预期窗口：6月FOMC维持3.50%-3.75%并继续强调抗通胀，纪要将在7月8日公布；同日还有10年期美债续发拍卖。一个看政策分歧，一个看长端资金愿不愿意接货。',
