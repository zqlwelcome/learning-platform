...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 美国“救美债”注入“强心针”，周四亚洲股市有望反弹；需要成交量继续确认。"
            },
            {
                "label": "宏观",
            ...
            {
                "label": "中国资产",
                "value": "国内新闻：1. 《全民医疗保障“十五五”规划》发布 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。美国“救美债”注入“强心针”，周四亚洲股市有望反弹 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
