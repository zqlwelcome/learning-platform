...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 分析师：美债收益率飙升或冲击亚洲AI牛市；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "国务院：住房公积金的存、贷利率由国务院决定 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
            ...
            {
                "label": "中国资产",
                "value": "肖远企：金融监管总局支持内地保险机构通过沪深港通投资香港交易所买卖基金（ET… 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "肖远企：金融监管总局支持内地保险机构通过沪深港通投资香港交易所买卖基金（ET… 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 国务院：住房公积金的存、贷利率由国务院决定 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。投资失手巨亏150亿美元 Jane Street暴露做市商对冲基金化背后的风险 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：德国拟发行30年期债券 收益率创2011年以来新高 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。分析师：美债收益率飙升或冲击亚洲AI牛市 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
