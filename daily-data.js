...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 金十数据整理：周六重要消息汇总；需要成交量继续确认。"
            },
            {
                "label": "宏观",
    ...
    "experts": {
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：美联储“三鹰”释疑为何赞成加息，美债收益率飙升沃什还能扛多久？ 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。金十数据整理：周六重要消息汇总 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
