...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 1. 据Mysteel，上周京津冀建筑钢材市场产量小幅增加，螺纹钢周总产…，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
            ...
            {
                "label": "宏观",
                "value": "6月22日财经早餐：美元走强限制金价涨幅，美伊瑞士谈判重启后又暂停，美油飙升… 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "伊朗代表团暂停伊美谈判，国际油价拉升近3%，黄金跌破4150美元，美股期指集… 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "均衡投资不是“躺平” 要让投资组合拥有时代感 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "伊朗代表团暂停伊美谈判，国际油价拉升近3%，黄金跌破4150美元，美股期指集… 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。1. 据Mysteel，上周京津冀建筑钢材市场产量小幅增加，螺纹钢周总产量较上周提升1.92 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 6月22日财经早餐：美元走强限制金价涨幅，美伊瑞士谈判重… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。低利率催化叠加银行渠道发力 FOF上半年新发规模超历史峰值 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：霍尔木兹海峡紧张局势持续，油价飙升、标普500股指期货下挫 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
    ...
    return [
        {
            ...
            region: '中国内需',
            impact: 'high',
            summary: '结果+市场解读：5月社零同比 -0.6%，工业增加值同比 +4.5%，1-5月固投同比 -4.1%，地产投资同比 -16.2%。市场读到的是“生产和出口还在撑，居民消费和地产仍在拖后腿”，所以内需复苏交易被明显降温。',
            thesis: '先改盈利预期和政策预期。制造和出口链还能扛利润，但消费、地产和地方信用修复被继续往后推。',
            assets: 'A股消费、地产链、建材、家电、白酒、港股内需、国债、人民币、高股息央国企。',
            flow: '热钱更容易继续留在出口制造、AI硬件、高股息和债券，先撤出地产链、可选消费和纯内需弹性票。若港股互联网能稳、地产和消费却跟不上，说明资金仍在做“结构性而非全面复苏”。',
            plan: '如果接下来6月LPR不动、地产销售也不改善，倾向继续把内需修复当反弹而不是反转；如果后续政策继续加码且人民币走稳，再考虑逐步提高消费和券商观察权重。',
            plain: '中国现在不是全线转弱，而是“工厂还能接单，居民还不敢多花钱”。'
        },
        {
            date: '2026-06-16',
            label: '06/16 结果',
            ...
            region: '套息资金',
            impact: 'high',
            summary: '结果+市场解读：日本央行把短端政策利率从 0.75% 上调到 1%，来到 31 年高位。市场没把它简单理解成“日股完了”，而是先重估日元融资成本和全球套息盘的承压程度。',
            thesis: '先改全球流动性和风险偏好，再改日股本地逻辑。便宜日元少一点，高波动资产的估值天花板就会低一点。',
            assets: '日元、日债、日股、美国科技股、港股成长、黄金、全球高波动资产。',
            flow: '如果美元兑日元持续下行、日债收益率继续抬升，快钱会先从纳指高贝塔、港股弹性和商品多头里抽一部分，回到现金和低波动资产；如果日元只是脉冲走强后又回软，说明套息盘还没真正大撤退。',
            plan: '如果接下来日元连续走强，倾向降低高杠杆和高波动仓位；如果市场很快消化这次加息、纳指和港股科技重新领涨，再把它视为“流动性冲击有限”的确认。',
            plain: '日本把借钱成本又抬高一点，全球拿便宜日元去冒险的资金就会先收一收。'
        },
        {
            date: '2026-06-17',
            label: '06/17 结果',
            ...
            region: '全球利率',
            impact: 'high',
            summary: '结果+市场解读：美联储把联邦基金利率维持在 3.5%-3.75%，同时6月预测里政策利率中枢和核心PCE路径都比3月更高。市场读成“不是马上再加，但降息门槛更高，higher for longer 还没结束”。',
            thesis: '核心改的是利率预期和流动性，其次才是风险偏好。维持不动不等于偏鸽，点阵图和通胀预测上修才是这次真正的鹰味来源。',
            assets: '2年和10年美债、美元、黄金、原油、纳指、A股和港股科技、REITs、高股息。',
            flow: '热钱更容易先回美元、短债、金融和能源，减少对高估值成长、黄金和新兴市场弹性的追价。若2年美债收益率和美元一起走高，而黄金和港股科技走弱，说明市场已经在交易“higher for longer”。',
            plan: '如果会后收益率继续抬升，倾向继续压低长久期成长仓位；如果收益率冲高回落、黄金和纳指能同步修复，再关注科技和贵金属的反弹延续，但不宜把一次反弹当成政策转向。',
            plain: '美联储没松口，市场就不会轻易相信“便宜钱很快回来”。'
        },
        {
            date: '2026-06-18',
            label: '06/18 结果',
            ...
            region: '欧洲利率',
            impact: 'medium',
            summary: '结果+市场解读：英国央行以 7 比 2 维持利率在 3.75%，但强调中东冲击后的能源价格和二轮通胀风险仍要盯。市场把它理解成“先按住不动，但不急着给宽松预期开门”。',
            thesis: '先改欧洲利率预期和风险偏好，再通过美元指数与全球长债定价间接影响其他资产。',
            assets: '英镑、英债、美元指数、欧洲银行股、黄金、港股和A股外资风险偏好。',
            flow: '如果英镑和英债收益率后续一起走高，说明全球“再通胀+高利率”交易还在加固，资金会更偏金融和能源、少碰高估值成长；如果英镑不强、全球长债反而走稳，热钱会更愿意回补黄金和科技。',
            plan: '如果英债收益率和美债一起抬升，倾向继续把全球高利率当主线；如果英国这边偏鹰但市场反应平淡，说明资金更在乎美国数据而不是欧洲单点事件。',
            plain: '英国这次没降息，也没真转鸽，意思是“别太早幻想欧洲的钱变便宜”。'
        },
        {
            date: '2026-06-22',
            label: '06/22 观察',
            ...
            region: '中国政策',
            impact: 'medium',
            summary: '预期窗口：LPR通常在每月20日公布，6月20日遇周六，市场大概率在6月22日观察。重点不是有没有 headline，而是1年期和5年期谁动、动完银行和地产成交有没有跟。',
            thesis: '改的是政策预期和信用预期。1年期偏实体融资，5年期偏按揭和地产。',
            assets: '银行、地产链、红利央国企、A股和港股券商、人民币汇率、国债。',
            flow: '如果只做口头支持不降价，资金更可能回高股息和出口链；如果5年期LPR下调幅度更大，地产链和港股本地金融才可能有短线回流。是否放量比标题更重要。',
            plan: '如果LPR不动且前面月度数据偏弱，倾向继续观望内需总攻；如果5年期意外下调并伴随地产成交改善，再考虑低位政策受益板块；如果只降1年期，更多把它理解成托信用而不是全面刺激地产。',
        ...
        },
        {
            ...
            region: '美国通胀',
            impact: 'high',
            summary: '预期窗口：6月25日美国会同天公布一季度GDP终值和5月PCE。真正决定交易方向的还是PCE，因为美联储刚把利率和通胀预测往上修，这份数据会决定市场把点阵图当“口头威胁”还是“真要执行”。',
            thesis: '先改利率预期和流动性，再改科技股、黄金和美元定价；GDP终值更多是验证增长韧性。',
            assets: '2年美债、美元、黄金、纳指、比特币、港股科技、人民币汇率、原油。',
            flow: '如果核心PCE高于市场预期，资金会继续留在美元、短债、金融和能源；如果核心PCE回落，热钱更可能从现金和防御回流科技、黄金和港股弹性。先盯2年美债与黄金是否同向还是分化。',
