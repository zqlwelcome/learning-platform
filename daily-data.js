...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 6月24日美股成交额前20：美光科技重挫13% 投资者避险引发抛售 市场…，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 美国债市：国债在股市下跌之际维持涨势 市场聚焦SpaceX发债；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "美元指数创11月以来最高水平 交易员上调美联储升息押注 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "大宗商品综述：油价走低 金融市场抛压之下黄金和基本金属全面下滑 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "摩根士丹利旗下70亿美元私募信贷基金限制赎回 回购上限设为5% 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "6月24日美股成交额前20：美光科技重挫13% 投资者避险引发抛售 市场聚焦… 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。6月24日美股成交额前20：美光科技重挫13% 投资者避险引发抛售 市场聚焦周三盘后财报 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 美元指数创11月以来最高水平 交易员上调美联储升息押注 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。美国债市：国债在股市下跌之际维持涨势 市场聚焦SpaceX发债 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：SpaceX通过债市募资250亿美元 认购需求显示市场心态谨慎 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。美国债市：国债在股市下跌之际维持涨势 市场聚焦SpaceX发债 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
    ...
    return [
        {
            date: '2026-06-23',
            label: '06/23 结果',
            event: '全球6月PMI初值 + 科技股回撤',
            region: '全球增长',
            impact: 'medium',
            summary: '结果+市场解读：欧元区综合PMI升到49.5但仍低于荣枯线，英国服务PMI降到48.7，说明制造补库存还能撑一段，服务需求和就业却在变弱。当天美股科技和半导体回撤，市场把“弱增长+高融资成本”一起交易。',
            thesis: '改的是风险偏好、盈利预期和利率敏感度。增长没有硬着陆，但服务业走弱会压企业收入，高利率又压长久期科技估值。',
            assets: '美元指数、欧元、英镑、德债和英债、美债收益率、黄金、纳指、半导体、港股科技、A股出口链。',
            flow: '热钱会先从欧洲消费、港股高β和高估值AI链撤一部分，转去美元现金、短债、黄金和现金流更稳的行业。若美元走强、黄金不跌、半导体继续弱，说明资金仍在降风险。',
            plan: '如果美国后续数据也走弱且收益率下行，可观察黄金和科技修复；如果收益率不降、科技继续放量下跌，倾向降低高估值成长追涨。',
            plain: '经济不是突然坏掉，但资金已经开始嫌贵、嫌不确定。'
        },
        {
            date: '2026-06-24',
            label: '06/24',
            event: '美联储2026银行压力测试结果',
            region: '美国金融',
            impact: 'medium',
            summary: '预期窗口：美联储将在6月24日美东时间16:00公布年度大型银行压力测试结果。它不是直接决定利率，但会影响银行分红回购、资本缓冲和金融股风险偏好。',
            thesis: '改的是金融体系风险溢价和流动性预期。银行资本越从容，市场越愿意相信信用没有收缩；结果若偏弱，会让资金重新担心贷款、商业地产和信用利差。',
            assets: '美国银行股、金融ETF、信用债、美元、短端美债、港股银行、A股银行和保险。',
            flow: '如果大型银行通过压力测试且资本压力小，热钱可能回补金融、价值和高股息；如果个别银行资本消耗大，资金会转向短债、美元和防御股，信用利差走阔就是预警。',
            plan: '如果金融股和信用债同步走强，可提高价值和高股息观察权重；如果银行股跌、信用利差走阔，倾向降低周期和高杠杆板块暴露。',
            plain: '这是给银行做体检，体检结果会影响市场敢不敢买金融股。'
        },
        {
            date: '2026-06-25',
            label: '06/25',
            ...
            region: '美国通胀',
            impact: 'high',
            summary: '预期窗口：BEA 6月25日公布Q1 GDP三次估计和5月个人收入支出，PCE通胀是主菜。4月PCE同比已经到3.8%，核心PCE也在3%以上，市场会看能源冲击是否继续传到消费价格。',
            thesis: '先改利率预期和流动性，再改科技股、黄金、美元和人民币定价。GDP终值验证增长韧性，PCE决定美联储能不能继续偏鹰。',
            assets: '2年美债、美元、黄金、纳指、比特币、港股科技、人民币汇率、原油。',
            flow: '如果核心PCE高于预期，资金会继续留在美元、短债、金融和能源，撤出长久期成长；如果核心PCE回落，热钱更可能从现金和防御回流科技、黄金和港股弹性。先盯2年美债、美元和黄金。',
        ...
        },
        {
            ...
            region: '中国盈利',
            impact: 'medium',
            summary: '预期窗口：中国工业利润会检验“制造强、内需弱”能不能继续撑A股盈利。1-4月利润同比增长18.2%，改善偏受AI相关需求、能源价格和上游利润推动，市场会看中下游有没有扩散。',
        ...
        },
        {
            ...
            region: '欧洲利率',
            impact: 'medium',
            summary: '预期窗口：ECB年度央行论坛在6月29日至7月1日举行，7月1日还有欧元区6月通胀初值。5月欧元区通胀已到3.2%，能源和服务价格仍是焦点，央行讲话会决定市场是否延长高利率交易。',
        ...
        },
        {
            ...
            region: '中国景气',
            impact: 'high',
            summary: '预期窗口：5月官方制造业PMI为50.0，新订单低于荣枯线，非制造业靠服务业勉强修复。国家统计局日程显示6月PMI将在6月30日公布，市场会看生产撑住后，订单和价格能不能跟上。',
        ...
        },
        {
            ...
            region: '全球制造',
            impact: 'high',
            summary: '预期窗口：中国私营制造业PMI、美国ISM制造业和日本短观同日接力。RatingDog 5月仍在51.8扩张，美国ISM 5月升到54，日本短观看企业是否接受更高利率和更强日元。',
        ...
        },
        {
            ...
            region: '美国服务通胀',
            impact: 'high',
            summary: '预期窗口：ISM日程显示6月服务业PMI将在7月6日公布。服务业比制造业更贴近工资、租金和核心通胀，所以它会影响市场对7月美联储会议前的最终利率定价。',
        ...
        },
        {
            ...
            region: '美元流动性',
            impact: 'medium',
            summary: '预期窗口：美国7月3日因独立日休市，非农后先进入薄盘；7月6日和7月7日又有短端国库券拍卖。重磅数据、假期低流动性和短端供给叠加，会检验美元现金需求是否继续紧。',
            thesis: '改的是流动性和美元资金价格。薄盘会放大第一反应，短债需求强说明现金仍有去处，风险资产反弹会被压；短债需求弱、收益率回落，才更像资金愿意重新加风险。',
            assets: '短端美债、美元指数、离岸人民币、黄金、纳指、港股科技、A股成长、比特币。',
            flow: '如果非农后美元和短端收益率同涨，热钱会继续停在美元现金和短债，撤出新兴市场高β；如果短端利率回落、人民币企稳，资金更可能回补黄金、科技和港股弹性。',
            plan: '如果薄盘急涨急跌但成交不足，倾向等7月6日服务业数据和7月7日短债拍卖后再确认；如果短端收益率下行且人民币稳住，可关注黄金、纳指和港股科技修复。',
            plain: '假期前后别只看一根K线，真正要看美元现金还香不香。'
        }
    ];
}
