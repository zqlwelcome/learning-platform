...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 韩国杠杆ETF热度降温 出现10亿美元资金流出；需要成交量继续确认。"
            },
            {
                "label": "宏观",
    ...
    "experts": {
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。韩国杠杆ETF热度降温 出现10亿美元资金流出 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
