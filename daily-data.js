...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "商品",
                "value": "8月20日隔夜要闻：美股转涨 油价升至三周高点 金价大涨 特朗普抱怨联储利率… 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
    ...
    "experts": {
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：美债回购或许只能放缓收益率上行步伐 但难扭转大势 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
