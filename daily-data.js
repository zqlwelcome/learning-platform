...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "宏观",
                "value": "金价一个月狂飙超10%！黄金突破4400美元后，华尔街却吵翻了：2%还是20… 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
            ...
            {
                "label": "风险",
                "value": "非沪籍居民及境外人士置换性购房政策微调？上海房地产交易中心热线回应 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 金价一个月狂飙超10%！黄金突破4400美元后，华尔街却… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
