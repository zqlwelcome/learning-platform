...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 圣路易斯联储行长谈及债市动荡 称市场并未质疑美联储信誉；需要成交量继续确认。"
            },
            {
                "label": "宏观",
            ...
            {
                "label": "商品",
                "value": "布伦特原油期货结算价为每桶93.78美元，上涨2.16美元，涨幅2.36% 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
    ...
    "experts": {
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：布伦特原油期货结算价为每桶93.78美元，上涨2.16美元，涨幅2.36% 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。圣路易斯联储行长谈及债市动荡 称市场并未质疑美联储信誉 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
