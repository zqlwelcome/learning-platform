...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 银河证券A股策略：建议以业绩为锚 在波动中把握结构性机会，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
            ...
            {
                "label": "宏观",
                "value": "富途老虎被罚引发1.37亿美元内幕交易疑云开庭听证：两大做市商联手追索神秘做… 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。银河证券A股策略：建议以业绩为锚 在波动中把握结构性机会 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 富途老虎被罚引发1.37亿美元内幕交易疑云开庭听证：两大… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
