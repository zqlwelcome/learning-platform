...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 英伟达为俄亥俄州OpenAI数据中心提供1050亿美元融资支持；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "红杉中国据悉寻求为其单飞以来的首支美元基金募资12亿美元 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "印度国家证券交易所据悉拟在印度创纪录IPO中争取最高 550 亿美元估值 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "红杉中国据悉寻求为其单飞以来的首支美元基金募资12亿美元 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "印度国家证券交易所据悉拟在印度创纪录IPO中争取最高 550 亿美元估值 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 红杉中国据悉寻求为其单飞以来的首支美元基金募资12亿美元 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：英伟达为俄亥俄州OpenAI数据中心提供1050亿美元融资支持 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。英伟达为俄亥俄州OpenAI数据中心提供1050亿美元融资支持 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
