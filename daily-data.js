...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 就业数据强化美联储加息押注 华尔街未出现全面避险，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 就业数据强化美联储加息押注 华尔街未出现全面避险；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "就业数据强化美联储加息押注 华尔街未出现全面避险 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "巴克莱：维持2026年布伦特原油价格预测为96美元/桶 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
            ...
            {
                "label": "风险",
                "value": "花旗推后预期的美联储降息时间 目前认为2027年降息三次 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。就业数据强化美联储加息押注 华尔街未出现全面避险 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 就业数据强化美联储加息押注 华尔街未出现全面避险 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。就业数据强化美联储加息押注 华尔街未出现全面避险 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
