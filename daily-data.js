...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 特朗普称将组建“人工智能部队”并任命AI事务负责人；需要成交量继续确认。"
            },
            {
                "label": "宏观",
            ...
            {
                "label": "风险",
                "value": "最新审查报告发现美联储未能妥善应对硅谷银行反复出现的问题 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        ...
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。英伟达5名高管披露持股变动：黄仁勋4.57万股用于缴税，CFO套现765万美元 可以看，但不能替代财报、负债和自由现金流。",
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。特朗普称将组建“人工智能部队”并任命AI事务负责人 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
