...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 零售数据爆冷！存储芯片逆市拉升，闪迪五日大涨35%，无人机概念股狂飙…；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "美国债务逼近40万亿美元，融资成本却创下25年新高！这40万亿真正约束的是什… 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 美国债务逼近40万亿美元，融资成本却创下25年新高！这4… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。零售数据爆冷！存储芯片逆市拉升，闪迪五日大涨35%，无人机概念股狂飙，油价反弹 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
