...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 国外1. 瑞穗预计日本央行将加快加息步伐，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 欧洲央行分析师：人工智能行情之后出现估值回调是大概率事件；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "美国联邦债务预计本周突破40万亿美元，早于国会预算办公室原测算 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "国外1. 瑞穗预计日本央行将加快加息步伐 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "港股收评：恒指涨0.09% 科指跌1.21% 内银股活跃 芯片股走弱 百度跌… 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。国外1. 瑞穗预计日本央行将加快加息步伐 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 美国联邦债务预计本周突破40万亿美元，早于国会预算办公室… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。美银：计入人工智能融资风险后，英伟达仍较自由现金流折价34%至50% 可以看，但不能替代财报、负债和自由现金流。",
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。欧洲央行分析师：人工智能行情之后出现估值回调是大概率事件 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
