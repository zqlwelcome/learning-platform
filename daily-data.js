...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "风险",
                "value": "美元深陷两股对立力量的博弈之中 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：中行、交行等大行落地自贸离岸债 上海“境内离岸”板块加速补齐 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
