...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "宏观",
                "value": "日元交易员静待日本央行行动，但不看好连续加息 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
            ...
            {
                "label": "风险",
                "value": "国内新闻：1. 国新办17日下午3时举行新闻发布会，介绍2026年7月份国民… 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 日元交易员静待日本央行行动，但不看好连续加息 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
