...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 为撑日元狂卖外国证券！日本当局干预、加息双管齐下收效甚微 市场戒备新一轮…，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 韩国担心芯片繁荣带来的收益流入房地产市场；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "为撑日元狂卖外国证券！日本当局干预、加息双管齐下收效甚微 市场戒备新一轮“抛… 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "为撑日元狂卖外国证券！日本当局干预、加息双管齐下收效甚微 市场戒备新一轮“抛… 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "国盛证券：百胜中国维持“买入”评级 收购必胜客中国增厚利润加速成长 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "韩监管机构对个股杠杆ETF过热交易表示担忧，将出台措施保护投资者 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。为撑日元狂卖外国证券！日本当局干预、加息双管齐下收效甚微 市场戒备新一轮“抛美债救日元”行动 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 为撑日元狂卖外国证券！日本当局干预、加息双管齐下收效甚微… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。摩根士丹利策略师称股市面临流动性收紧风险 可以看，但不能替代财报、负债和自由现金流。",
            "action": "优先看现金流强、负债可控、能分红或回购的公司/ETF；对只靠故事融资、还没证明盈利能力的标的保持距离。"
        },
        "munger": {
            "insight": "芒格会提醒先防蠢：澳元面临地缘风险与鹰派政策的双重拉扯，交易员该如何布局？ 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。韩国担心芯片繁荣带来的收益流入房地产市场 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
    ...
    return [
        {
            ...
            region: '全球利率',
            impact: 'high',
            summary: '结果+市场解读：美联储维持 3.50%-3.75% 不变，但新主席 Warsh 把沟通重心放在 2%通胀目标和数据依赖上，市场同时看到年内加息风险和更少前瞻指引。它不是“没加息=鸽”，而是“降息门槛更高、波动率更贵”。',
            thesis: '先改利率预期和流动性，再压风险偏好。核心变量不是这次按兵不动，而是市场要重新给通胀上行和政策不透明定价。',
            assets: '2年和10年美债、美元、黄金、原油、纳指、A股和港股科技、REITs、高股息。',
            flow: '热钱更愿意先留在美元、短债、金融和能源，少追高估值成长和新兴市场弹性。若2年美债收益率和美元同步上行、黄金和港股科技转弱，说明市场已在交易“高利率更久”。',
            plan: '如果本周PCE继续偏热且美债收益率上行，倾向降低长久期成长和港股高弹性仓位；如果PCE降温并带动收益率回落，再看黄金、纳指和港股科技能否形成反弹确认。',
            plain: '美联储现在的意思是：便宜钱不会因为股市想要就马上回来。'
        },
        {
            date: '2026-06-22',
            label: '06/22 结果',
            ...
            region: '中国政策',
            impact: 'medium',
            summary: '结果+市场解读：中国1年期LPR维持 3.0%，5年期LPR维持 3.5%，连续多月按兵不动。市场读到的是“政策还在稳信用，但暂时不愿用降贷款利率做强刺激”，所以地产和消费的修复交易仍缺少硬催化。',
            thesis: '改的是政策预期和信用预期。1年期影响企业融资，5年期影响按揭和地产信心；两端都不动，说明政策托底大于总攻。',
            assets: 'A股银行、地产链、建材、家电、券商、国债、人民币、港股内房和本地金融、高股息央国企。',
            flow: '热钱更可能继续留在高股息、出口制造、AI硬件和债券，少做地产链和纯内需β。如果地产股不跟、银行和红利相对稳，说明资金接受“弱刺激、弱修复”的定价。',
            plan: '如果后续地产成交和社融没有改善，倾向把内需板块反弹当交易而不是反转；如果后面出现财政加码、人民币走稳和地产成交同步修复，再提高消费、券商和地产链观察权重。',
            plain: '贷款基准利率没降，说明政策还在托底，但暂时没给楼市和消费踩大油门。'
        },
        {
            date: '2026-06-23',
            label: '06/23',
        ...
        },
        {
            ...
            region: '美国通胀',
            impact: 'high',
            summary: '预期窗口：6月25日公布5月个人收入支出和PCE，市场尤其盯核心PCE。美联储刚强调通胀目标，这份数据会决定投资者是继续相信年内加息风险，还是开始回补降息交易。',
            thesis: '先改利率预期和流动性，再改科技股、黄金、美元和人民币定价。GDP终值更多验证增长韧性，PCE才是主菜。',
            assets: '2年美债、美元、黄金、纳指、比特币、港股科技、人民币汇率、原油。',
            flow: '如果核心PCE高于预期，资金会继续留在美元、短债、金融和能源；如果核心PCE回落，热钱更可能从现金和防御回流科技、黄金和港股弹性。先盯2年美债和黄金的方向。',
        ...
        },
        {
            ...
            region: '中国景气',
            impact: 'high',
            summary: '预期窗口：6月PMI会告诉市场，5月那种“出口和制造撑着、内需偏弱”的组合，是在改善还是在扩散。重点看制造业是否继续站上荣枯线，以及新订单、原材料价格和建筑业分项。',
        ...
        },
        {
            date: '2026-07-01',
            label: '07/01',
            event: '日本Tankan + 美国ISM制造业',
            region: '全球制造',
            impact: 'high',
            summary: '预期窗口：日本央行7月1日公布6月Tankan，美国ISM同日公布6月制造业。日本刚加息到1%，美国5月ISM制造业已升至54，市场会同时验证日本企业能不能扛住高日元融资成本、美国制造是否还在扩张。',
            thesis: '同时改盈利预期、利率预期和套息资金风险。日本企业信心强会支持日股和加息路径；美国ISM强会强化高利率更久。',
            assets: '日元、日股、日债、美债、美元、纳指、铜、原油、A股制造链、港股科技。',
            flow: '如果Tankan强、日元走强，套息资金可能继续收缩，全球高贝塔承压；如果ISM强且价格分项高，美债收益率可能上行，资金偏美元和周期。若两边都弱，热钱会转向债券、黄金和防御。',
            plan: '如果日本和美国制造数据都强，倾向降低对“马上宽松”的押注；如果日本弱、美国也弱，可观察黄金和债券，但股票要确认不是衰退交易。',
            plain: '这一天看两个大工厂体系：日本企业有没有信心，美国制造有没有继续热。'
        },
        {
            date: '2026-07-02',
            label: '07/02',
