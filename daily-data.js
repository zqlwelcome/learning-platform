...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "宏观",
                "value": "特朗普称解决40万亿美债问题要靠增长 否认指示贝森特干预债市 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 特朗普称解决40万亿美债问题要靠增长 否认指示贝森特干预… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
