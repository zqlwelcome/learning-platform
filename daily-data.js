...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 王毅同芬兰外长瓦尔托宁会谈；需要成交量继续确认。"
            },
            {
                "label": "宏观",
            ...
            {
                "label": "风险",
                "value": "王毅同芬兰外长瓦尔托宁会谈 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。王毅同芬兰外长瓦尔托宁会谈 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
