...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 美银调查显示 印度已取代印尼成为亚洲最不受青睐的股市，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
            ...
            {
                "label": "宏观",
                "value": "路透社/益普索民调：63%的美国人表示，特朗普及其家族去年通过加密货币项目获… 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "美银调查显示 印度已取代印尼成为亚洲最不受青睐的股市 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "微博发布Q2财报 季度总营收30.8亿元 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "SK海力士拟回购40万亿韩元普通股，认为股价被低估 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。美银调查显示 印度已取代印尼成为亚洲最不受青睐的股市 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 路透社/益普索民调：63%的美国人表示，特朗普及其家族去… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。日本东证指数创3月以来最大跌幅 债券收益率飙升冲击AI板块 可以看，但不能替代财报、负债和自由现金流。",
