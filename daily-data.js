...
const _EMBEDDED_DATA = {
    ...
    "experts": {
        ...
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。据The Information：百度芯片部门昆仑芯计划以500亿美元的估值赴港上市，IPO 可以看，但不能替代财报、负债和自由现金流。",
