...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "中国资产",
                "value": "微盟上半年实现AI收入1.33亿元 同比增长89.2% 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "欧洲央行管委Rehn：前瞻性指引应继续保留 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：分析师：美债收益率飙升或冲击亚洲AI牛市 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
