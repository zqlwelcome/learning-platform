...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 大摩启动1.5万亿美元美国创新基础设施计划 聚焦AI等前沿技术，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 大摩启动1.5万亿美元美国创新基础设施计划 聚焦AI等前沿技术；需要成交量继续确认。"
            },
            {
                "label": "宏观",
            ...
            {
                "label": "商品",
                "value": "黄金创下七个月最佳单周表现 迈克・库为何继续加仓黄金 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
                "value": "深夜，直线跳水！美股巨头，突传利空！ 更适合作为结构性线索，看港股/A股是否有资金跟进。"
            },
            {
                "label": "风险",
                "value": "特朗普称自沃什履新以来仅与其短暂交谈一次 否认频繁沟通 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。大摩启动1.5万亿美元美国创新基础设施计划 聚焦AI等前沿技术 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 凯文·沃什重塑美联储：AI驱动新范式遇上顽固通胀的“钢丝… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
            "insight": "巴菲特会把今天的新闻先翻译成现金流问题：利率如果上去，估值就会被压；如果企业有定价权，反而能穿越波动。特朗普称自沃什履新以来仅与其短暂交谈一次 否认频繁沟通 可以看，但不能替代财报、负债和自由现金流。",
        ...
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。大摩启动1.5万亿美元美国创新基础设施计划 聚焦AI等前沿技术 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
