...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            ...
            {
                "label": "资金",
                "value": "资金更偏向有叙事和流动性的方向，例如 银行据悉大幅削减SK海力士韩国股票的杠杆投资成本；需要成交量继续确认。"
            },
            {
                "label": "宏观",
                "value": "美国财政部扩大长债回购压低长端利率，美元走弱提振金价 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "光大期货0820黄金点评：美债收益率大幅下行，金价重获提振 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
    ...
    "experts": {
        "templeton": {
            ...
            "action": "不追涨最热芯片/IPO叙事；关注被 美国财政部扩大长债回购压低长端利率，美元走弱提振金价 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：美国股市：标普500指数结束三连跌 美财政部扩大国债回购提振债市 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
            "action": "把仓位拆小，要求“新闻催化 + 价格趋势 + 成交量 + 风控位”同时满足；不满足就只观察，不硬下单。"
        },
        "duan": {
            "insight": "段永平会回到好生意：新闻只是入口，不是买入理由。银行据悉大幅削减SK海力士韩国股票的杠杆投资成本 背后如果能变成真实订单、利润和用户价值，才值得长期跟踪；否则只是今天热闹。",
