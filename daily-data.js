...
function getForwardRadarEvents() {
    return [
        ...
        {
            date: '2026-07-07',
            label: '07/07 结果+07/08',
            event: '中国6月外储回落 + 美国贸易与短端融资压力',
            region: '人民币/外需',
            impact: 'medium',
            summary: '结果+市场解读：国家外汇管理局公布，6月末外汇储备34163亿美元，较5月末下降260亿美元，降幅0.75%。这不是单纯资本外流信号，更像美元走强、资产价格波动和汇率折算共同压低账面规模。市场接下来要看人民币是否守稳、美国贸易数据是否推高美元需求，以及短端美债拍卖会不会继续抬高美元现金回报。',
            thesis: '改的是人民币预期和跨境流动性。外储回落但仍在3.4万亿美元附近，说明人民币底气没有明显破坏；若美元现金回报继续高，热钱仍会偏向美元资产。',
            assets: '离岸人民币、A股出口链、港股科技、航运、家电、机械、美元、3年美债、黄金。',
            flow: '如果外储回落后人民币不贬、港股不缩量，说明资金没有把它交易成资本外流；如果美元指数和短端收益率同步上行，资金会先撤出新兴市场高β，回到美元现金和短债。',
            plan: '如果人民币稳定且港股放量，可继续观察出口制造和港股科技；如果人民币走弱、美元走强或美国短端收益率上行，倾向降低新兴市场高β仓位。',
            plain: '外储少了一点，关键不是数字本身，而是人民币和港股有没有被资金继续卖。'
        },
        {
            date: '2026-07-08',
            label: '07/08',
