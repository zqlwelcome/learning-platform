...
const _EMBEDDED_DATA = {
    ...
    "mood": {
        ...
        "dimensions": [
            {
                "label": "趋势",
                "value": "主线看 华泰宏观：7月美联储加息概率略高于一半，热度在，但不能把热度直接当买点。"
            },
            {
                "label": "资金",
            ...
            {
                "label": "宏观",
                "value": "美联储利率决议进入倒计时，城堡证券发出沃什可能意外加息的预警后，引爆了市场焦… 是今天的估值开关，影响利率、美元和成长股定价。"
            },
            {
                "label": "商品",
                "value": "油价连跌三日后上涨 美国击退伊朗的突袭企图 提醒黄金/资源类资产不能只看单日涨跌，要看通胀和实际利率。"
            },
            {
                "label": "中国资产",
            ...
            {
                "label": "风险",
                "value": "油价连跌三日后上涨 美国击退伊朗的突袭企图 说明地缘和政策仍会突然改变风险偏好，仓位要留余地。"
            }
        ],
    ...
    "experts": {
        "templeton": {
            "insight": "邓普顿会先问：大家是不是已经太兴奋了。华泰宏观：7月美联储加息概率略高于一半 说明热门主线还在吸引资金，但越热越要找反向证据。真正的机会通常不在最吵的地方，而在被同一条宏观新闻错杀、但基本面没有坏掉的资产里。",
            "action": "不追涨最热芯片/IPO叙事；关注被 美联储利率决议进入倒计时，城堡证券发出沃什可能意外加息的… 压住估值、但现金流稳定的港股/A股龙头或宽基基金。"
        },
        "buffett": {
        ...
        "munger": {
            "insight": "芒格会提醒先防蠢：美联储利率决议进入倒计时，城堡证券发出沃什可能意外加息的预警后，引爆了市场焦虑！随着交易员加 这种新闻容易让人只看涨跌，不看赔率。好决策要先问最坏情况、拥挤程度和退出纪律，尤其在黄金、AI、IPO同时热的时候。",
